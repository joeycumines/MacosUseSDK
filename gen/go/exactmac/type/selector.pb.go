...
func (CompoundSelector_Operator) Descriptor() protoreflect.EnumDescriptor {
	return file_exactmac_type_selector_proto_enumTypes[0].Descriptor()
}

func (CompoundSelector_Operator) Type() protoreflect.EnumType {
	return &file_exactmac_type_selector_proto_enumTypes[0]
}
...
func (CompoundSelector_Operator) EnumDescriptor() ([]byte, []int) {
	return file_exactmac_type_selector_proto_rawDescGZIP(), []int{3, 0}
}
...
func (x *ElementSelector) Reset() {
	*x = ElementSelector{}
	mi := &file_exactmac_type_selector_proto_msgTypes[0]
...
func (*ElementSelector) Descriptor() ([]byte, []int) {
	return file_exactmac_type_selector_proto_rawDescGZIP(), []int{0}
}
...
func (x *PositionSelector) Reset() {
	*x = PositionSelector{}
	mi := &file_exactmac_type_selector_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*PositionSelector) Descriptor() ([]byte, []int) {
	return file_exactmac_type_selector_proto_rawDescGZIP(), []int{1}
}
...
func (x *AttributeSelector) Reset() {
	*x = AttributeSelector{}
	mi := &file_exactmac_type_selector_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AttributeSelector) Descriptor() ([]byte, []int) {
	return file_exactmac_type_selector_proto_rawDescGZIP(), []int{2}
}
...
func (x *CompoundSelector) Reset() {
	*x = CompoundSelector{}
	mi := &file_exactmac_type_selector_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
var File_exactmac_type_selector_proto protoreflect.FileDescriptor
...
const file_exactmac_type_selector_proto_rawDesc = "" +
	...
	"\n" +
	"attributes\x18\x06 \x01(\v2 .exactmac.type.AttributeSelectorH\x00R\n" +
	"attributes\x12=\n" +
	"\bcompound\x18\a \x01(\v2\x1f.exactmac.type.CompoundSelectorH\x00R\bcompoundB\n" +
	"\n" +
	"\bcriteria\"q\n" +
	...
	"\x02_xB\x04\n" +
	"\x02_y\"\xa9\x01\n" +
	"\x11AttributeSelector\x12U\n" +
	"\n" +
	"attributes\x18\x01 \x03(\v20.exactmac.type.AttributeSelector.AttributesEntryB\x03\xe0A\x02R\n" +
	"attributes\x1a=\n" +
	...
	"\fOPERATOR_NOT\x10\x03B\xad\x01\n" +
	"\x11com.exactmac.typeB\rSelectorProtoP\x01Z4github.com/joeycumines/ExactMac/gen/go/exactmac/type\xa2\x02\x03ETX\xaa\x02\rExactmac.Type\xca\x02\rExactmac\\Type\xe2\x02\x19Exactmac\\Type\\GPBMetadata\xea\x02\x0eExactmac::Typeb\x06proto3"

var (
	file_exactmac_type_selector_proto_rawDescOnce sync.Once
	file_exactmac_type_selector_proto_rawDescData []byte
)

func file_exactmac_type_selector_proto_rawDescGZIP() []byte {
	file_exactmac_type_selector_proto_rawDescOnce.Do(func() {
		file_exactmac_type_selector_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_exactmac_type_selector_proto_rawDesc), len(file_exactmac_type_selector_proto_rawDesc)))
	})
	return file_exactmac_type_selector_proto_rawDescData
}

var file_exactmac_type_selector_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_exactmac_type_selector_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_exactmac_type_selector_proto_goTypes = []any{
	(CompoundSelector_Operator)(0), // 0: exactmac.type.CompoundSelector.Operator
	(*ElementSelector)(nil),        // 1: exactmac.type.ElementSelector
	(*PositionSelector)(nil),       // 2: exactmac.type.PositionSelector
	(*AttributeSelector)(nil),      // 3: exactmac.type.AttributeSelector
	(*CompoundSelector)(nil),       // 4: exactmac.type.CompoundSelector
	nil,                            // 5: exactmac.type.AttributeSelector.AttributesEntry
}
var file_exactmac_type_selector_proto_depIdxs = []int32{
	2, // 0: exactmac.type.ElementSelector.position:type_name -> exactmac.type.PositionSelector
...
func init() { file_exactmac_type_selector_proto_init() }
func file_exactmac_type_selector_proto_init() {
	if File_exactmac_type_selector_proto != nil {
		return
	}
	...
	file_exactmac_type_selector_proto_msgTypes[1].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_exactmac_type_selector_proto_rawDesc), len(file_exactmac_type_selector_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_exactmac_type_selector_proto_goTypes,
		DependencyIndexes: file_exactmac_type_selector_proto_depIdxs,
		EnumInfos:         file_exactmac_type_selector_proto_enumTypes,
		MessageInfos:      file_exactmac_type_selector_proto_msgTypes,
	}.Build()
	File_exactmac_type_selector_proto = out.File
	file_exactmac_type_selector_proto_goTypes = nil
	file_exactmac_type_selector_proto_depIdxs = nil
}
