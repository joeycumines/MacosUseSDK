...
func (ApplicationView) Descriptor() protoreflect.EnumDescriptor {
	return file_exactmac_v1_application_proto_enumTypes[0].Descriptor()
}

func (ApplicationView) Type() protoreflect.EnumType {
	return &file_exactmac_v1_application_proto_enumTypes[0]
}
...
func (ApplicationView) EnumDescriptor() ([]byte, []int) {
	return file_exactmac_v1_application_proto_rawDescGZIP(), []int{0}
}
...
func (x *ApplicationBundle) Reset() {
	*x = ApplicationBundle{}
	mi := &file_exactmac_v1_application_proto_msgTypes[0]
...
func (x *Application) Reset() {
	*x = Application{}
	mi := &file_exactmac_v1_application_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Application) Descriptor() ([]byte, []int) {
	return file_exactmac_v1_application_proto_rawDescGZIP(), []int{1}
}
...
var File_exactmac_v1_application_proto protoreflect.FileDescriptor

const file_exactmac_v1_application_proto_rawDesc = "" +
	"\n" +
	"\x1dexactmac/v1/application.proto\x12\vexactmac.v1\x1a\x1fgoogle/api/field_behavior.proto\x1a\x19google/api/resource.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\xae\x02\n" +
	...
	"\aversion\x18\x05 \x01(\tB\x03\xe0A\x03R\aversion:s\xeaAp\n" +
	"\x1eexactmac.com/ApplicationBundle\x12'applicationBundles/{application_bundle}*\x12applicationBundles2\x11applicationBundle\"\xa0\x03\n" +
	"\vApplication\x12\x17\n" +
	"\x04name\x18\x01 \x01(\tB\x03\xe0A\bR\x04name\x12\x15\n" +
	"\x03pid\x18\x02 \x01(\x05B\x03\xe0A\x03R\x03pid\x12&\n" +
	"\fdisplay_name\x18\x03 \x01(\tB\x03\xe0A\x03R\vdisplayName\x12U\n" +
	"\x12application_bundle\x18\x04 \x01(\tB&\xe0A\x03\xfaA \n" +
	"\x1eexactmac.com/ApplicationBundleR\x11applicationBundle\x12 \n" +
	"\tbundle_id\x18\x05 \x01(\tB\x03\xe0A\x03R\bbundleId\x12\x1b\n" +
	"\x06active\x18\x06 \x01(\bB\x03\xe0A\x03R\x06active\x12M\n" +
	"\x12process_start_time\x18\a \x01(\v2\x1a.google.protobuf.TimestampB\x03\xe0A\x03R\x10processStartTime:T\xeaAQ\n" +
	"\x18exactmac.com/Application\x12\x1aapplications/{application}*\fapplications2\vapplication*j\n" +
	"\x0fApplicationView\x12 \n" +
	"\x1cAPPLICATION_VIEW_UNSPECIFIED\x10\x00\x12\x1a\n" +
	"\x16APPLICATION_VIEW_BASIC\x10\x01\x12\x19\n" +
	"\x15APPLICATION_VIEW_FULL\x10\x02B\xaf\x01\n" +
	"\x0fcom.exactmac.v1B\x10ApplicationProtoP\x01Z=github.com/joeycumines/ExactMac/gen/go/exactmac/v1;exactmacv1\xa2\x02\x03EXX\xaa\x02\vExactmac.V1\xca\x02\vExactmac\\V1\xe2\x02\x17Exactmac\\V1\\GPBMetadata\xea\x02\fExactmac::V1b\x06proto3"

var (
	file_exactmac_v1_application_proto_rawDescOnce sync.Once
	file_exactmac_v1_application_proto_rawDescData []byte
)

func file_exactmac_v1_application_proto_rawDescGZIP() []byte {
	file_exactmac_v1_application_proto_rawDescOnce.Do(func() {
		file_exactmac_v1_application_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_exactmac_v1_application_proto_rawDesc), len(file_exactmac_v1_application_proto_rawDesc)))
	})
	return file_exactmac_v1_application_proto_rawDescData
}

var file_exactmac_v1_application_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_exactmac_v1_application_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_exactmac_v1_application_proto_goTypes = []any{
	(ApplicationView)(0),          // 0: exactmac.v1.ApplicationView
	(*ApplicationBundle)(nil),     // 1: exactmac.v1.ApplicationBundle
	(*Application)(nil),           // 2: exactmac.v1.Application
	(*timestamppb.Timestamp)(nil), // 3: google.protobuf.Timestamp
}
var file_exactmac_v1_application_proto_depIdxs = []int32{
	3, // 0: exactmac.v1.Application.process_start_time:type_name -> google.protobuf.Timestamp
...
func init() { file_exactmac_v1_application_proto_init() }
func file_exactmac_v1_application_proto_init() {
	if File_exactmac_v1_application_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_exactmac_v1_application_proto_rawDesc), len(file_exactmac_v1_application_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_exactmac_v1_application_proto_goTypes,
		DependencyIndexes: file_exactmac_v1_application_proto_depIdxs,
		EnumInfos:         file_exactmac_v1_application_proto_enumTypes,
		MessageInfos:      file_exactmac_v1_application_proto_msgTypes,
	}.Build()
	File_exactmac_v1_application_proto = out.File
	file_exactmac_v1_application_proto_goTypes = nil
	file_exactmac_v1_application_proto_depIdxs = nil
}
