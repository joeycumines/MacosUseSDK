...
const file_exactmac_v1_display_proto_rawDesc = "" +
	"\n" +
	"\x19exactmac/v1/display.proto\x12\vexactmac.v1\x1a\x1cexactmac/type/geometry.proto\x1a\x1fgoogle/api/field_behavior.proto\x1a\x19google/api/resource.proto\"\xb4\x02\n" +
	"\aDisplay\x12\x17\n" +
	...
	"\x05scale\x18\x06 \x01(\x01B\x03\xe0A\x03R\x05scale:@\xeaA=\n" +
	"\x14exactmac.com/Display\x12\x12displays/{display}*\bdisplays2\adisplay\"[\n" +
	"\x13ListDisplaysRequest\x12 \n" +
	"\tpage_size\x18\x01 \x01(\x05B\x03\xe0A\x01R\bpageSize\x12\"\n" +
	"\n" +
	"page_token\x18\x02 \x01(\tB\x03\xe0A\x01R\tpageToken\"E\n" +
	"\x11GetDisplayRequest\x120\n" +
	"\x04name\x18\x01 \x01(\tB\x1c\xe0A\x02\xfaA\x16\n" +
	"\x14exactmac.com/DisplayR\x04name\"z\n" +
	...
	"\x1cCaptureCursorPositionRequest\"}\n" +
	"\x1dCaptureCursorPositionResponse\x12\x11\n" +
	"\x01x\x18\x01 \x01(\x01B\x03\xe0A\x03R\x01x\x12\x11\n" +
	"\x01y\x18\x02 \x01(\x01B\x03\xe0A\x03R\x01y\x126\n" +
	"\adisplay\x18\x03 \x01(\tB\x1c\xe0A\x03\xfaA\x16\n" +
	"\x14exactmac.com/DisplayR\adisplayB\xab\x01\n" +
	"\x0fcom.exactmac.v1B\fDisplayProtoP\x01Z=github.com/joeycumines/ExactMac/gen/go/exactmac/v1;exactmacv1\xa2\x02\x03EXX\xaa\x02\vExactmac.V1\xca\x02\vExactmac\\V1\xe2\x02\x17Exactmac\\V1\\GPBMetadata\xea\x02\fExactmac::V1b\x06proto3"
