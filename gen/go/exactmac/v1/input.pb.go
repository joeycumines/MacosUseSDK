...
const file_exactmac_v1_input_proto_rawDesc = "" +
	"\n" +
	"\x17exactmac/v1/input.proto\x12\vexactmac.v1\x1a\x1cexactmac/type/geometry.proto\x1a\x1fgoogle/api/field_behavior.proto\x1a\x19google/api/resource.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\x8e\x05\n" +
	"\x05Input\x12\x17\n" +
	...
	"\x0fSTATE_CANCELLED\x10\x05:Q\xeaAN\n" +
	"\x12exactmac.com/Input\x12)applications/{application}/inputs/{input}*\x06inputs2\x05input\"\xe6\x01\n" +
	"\vInputTarget\x12A\n" +
	"\vapplication\x18\x01 \x01(\tB\x1d\xfaA\x1a\n" +
	"\x18exactmac.com/ApplicationH\x00R\vapplication\x122\n" +
	"\x06window\x18\x02 \x01(\tB\x18\xfaA\x15\n" +
	"\x13exactmac.com/WindowH\x00R\x06window\x125\n" +
	"\adisplay\x18\x03 \x01(\tB\x19\xfaA\x16\n" +
	"\x14exactmac.com/DisplayH\x00R\adisplay\x12\x1a\n" +
	...
	"\x05Hover\x125\n" +
	"\bposition\x18\x01 \x01(\v2\x14.exactmac.type.PointB\x03\xe0A\x02R\bposition\x12\x1f\n" +
	"\bduration\x18\x02 \x01(\x01B\x03\xe0A\x02R\bdurationB\xa9\x01\n" +
	"\x0fcom.exactmac.v1B\n" +
