...
func (Session_State) Descriptor() protoreflect.EnumDescriptor {
	return file_exactmac_v1_session_proto_enumTypes[0].Descriptor()
}

func (Session_State) Type() protoreflect.EnumType {
	return &file_exactmac_v1_session_proto_enumTypes[0]
}
...
func (Session_State) EnumDescriptor() ([]byte, []int) {
	return file_exactmac_v1_session_proto_rawDescGZIP(), []int{0, 0}
}
...
func (Transaction_State) Descriptor() protoreflect.EnumDescriptor {
	return file_exactmac_v1_session_proto_enumTypes[1].Descriptor()
}

func (Transaction_State) Type() protoreflect.EnumType {
	return &file_exactmac_v1_session_proto_enumTypes[1]
}
...
func (Transaction_State) EnumDescriptor() ([]byte, []int) {
	return file_exactmac_v1_session_proto_rawDescGZIP(), []int{1, 0}
}
...
type Session struct {
	...
	State Session_State `protobuf:"varint,3,opt,name=state,proto3,enum=exactmac.v1.Session_State" json:"state,omitempty"`
...
func (x *Session) Reset() {
	*x = Session{}
	mi := &file_exactmac_v1_session_proto_msgTypes[0]
...
func (*Session) Descriptor() ([]byte, []int) {
	return file_exactmac_v1_session_proto_rawDescGZIP(), []int{0}
}
...
type Transaction struct {
	...
	// Transaction state.
	State Transaction_State `protobuf:"varint,3,opt,name=state,proto3,enum=exactmac.v1.Transaction_State" json:"state,omitempty"`
...
func (x *Transaction) Reset() {
	*x = Transaction{}
	mi := &file_exactmac_v1_session_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Transaction) Descriptor() ([]byte, []int) {
	return file_exactmac_v1_session_proto_rawDescGZIP(), []int{1}
}
...
func (x *SessionSnapshot) Reset() {
	*x = SessionSnapshot{}
	mi := &file_exactmac_v1_session_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SessionSnapshot) Descriptor() ([]byte, []int) {
	return file_exactmac_v1_session_proto_rawDescGZIP(), []int{2}
}
...
func (x *OperationRecord) Reset() {
	*x = OperationRecord{}
	mi := &file_exactmac_v1_session_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*OperationRecord) Descriptor() ([]byte, []int) {
	return file_exactmac_v1_session_proto_rawDescGZIP(), []int{3}
}
...
var File_exactmac_v1_session_proto protoreflect.FileDescriptor

const file_exactmac_v1_session_proto_rawDesc = "" +
	"\n" +
	"\x19exactmac/v1/session.proto\x12\vexactmac.v1\x1a\x1fgoogle/api/field_behavior.proto\x1a\x19google/api/resource.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\xc8\x05\n" +
	"\aSession\x12\x17\n" +
	"\x04name\x18\x01 \x01(\tB\x03\xe0A\bR\x04name\x12&\n" +
	"\fdisplay_name\x18\x02 \x01(\tB\x03\xe0A\x01R\vdisplayName\x125\n" +
	"\x05state\x18\x03 \x01(\x0e2\x1a.exactmac.v1.Session.StateB\x03\xe0A\x03R\x05state\x12@\n" +
	...
	"\fSTATE_FAILED\x10\x05:@\xeaA=\n" +
	"\x14exactmac.com/Session\x12\x12sessions/{session}*\bsessions2\asession\"\xd0\x03\n" +
	"\vTransaction\x12*\n" +
	"\x0etransaction_id\x18\x01 \x01(\tB\x03\xe0A\x03R\rtransactionId\x126\n" +
	"\asession\x18\x02 \x01(\tB\x1c\xe0A\x03\xfaA\x16\n" +
	"\x14exactmac.com/SessionR\asession\x129\n" +
	"\x05state\x18\x03 \x01(\x0e2\x1e.exactmac.v1.Transaction.StateB\x03\xe0A\x03R\x05state\x12>\n" +
	"\n" +
	"start_time\x18\x04 \x01(\v2\x1a.google.protobuf.TimestampB\x03\xe0A\x03R\tstartTime\x12.\n" +
	"\x10operations_count\x18\x05 \x01(\x05B\x03\xe0A\x03R\x0foperationsCount\x12B\n" +
	"\x0fupdated_session\x18\x06 \x01(\v2\x14.exactmac.v1.SessionB\x03\xe0A\x03R\x0eupdatedSession\"n\n" +
	"\x05State\x12\x15\n" +
	"\x11STATE_UNSPECIFIED\x10\x00\x12\x10\n" +
	...
	"\x0etransaction_id\x18\x06 \x01(\tB\x03\xe0A\x03R\rtransactionIdB\xab\x01\n" +
	"\x0fcom.exactmac.v1B\fSessionProtoP\x01Z=github.com/joeycumines/ExactMac/gen/go/exactmac/v1;exactmacv1\xa2\x02\x03EXX\xaa\x02\vExactmac.V1\xca\x02\vExactmac\\V1\xe2\x02\x17Exactmac\\V1\\GPBMetadata\xea\x02\fExactmac::V1b\x06proto3"

var (
	file_exactmac_v1_session_proto_rawDescOnce sync.Once
	file_exactmac_v1_session_proto_rawDescData []byte
)

func file_exactmac_v1_session_proto_rawDescGZIP() []byte {
	file_exactmac_v1_session_proto_rawDescOnce.Do(func() {
		file_exactmac_v1_session_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_exactmac_v1_session_proto_rawDesc), len(file_exactmac_v1_session_proto_rawDesc)))
	})
	return file_exactmac_v1_session_proto_rawDescData
}

var file_exactmac_v1_session_proto_enumTypes = make([]protoimpl.EnumInfo, 2)
var file_exactmac_v1_session_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_exactmac_v1_session_proto_goTypes = []any{
	(Session_State)(0),            // 0: exactmac.v1.Session.State
	(Transaction_State)(0),        // 1: exactmac.v1.Transaction.State
	(*Session)(nil),               // 2: exactmac.v1.Session
	(*Transaction)(nil),           // 3: exactmac.v1.Transaction
	(*SessionSnapshot)(nil),       // 4: exactmac.v1.SessionSnapshot
	(*OperationRecord)(nil),       // 5: exactmac.v1.OperationRecord
	nil,                           // 6: exactmac.v1.Session.MetadataEntry
	(*timestamppb.Timestamp)(nil), // 7: google.protobuf.Timestamp
}
var file_exactmac_v1_session_proto_depIdxs = []int32{
	0,  // 0: exactmac.v1.Session.state:type_name -> exactmac.v1.Session.State
	7,  // 1: exactmac.v1.Session.create_time:type_name -> google.protobuf.Timestamp
	7,  // 2: exactmac.v1.Session.last_access_time:type_name -> google.protobuf.Timestamp
	7,  // 3: exactmac.v1.Session.expire_time:type_name -> google.protobuf.Timestamp
	6,  // 4: exactmac.v1.Session.metadata:type_name -> exactmac.v1.Session.MetadataEntry
	1,  // 5: exactmac.v1.Transaction.state:type_name -> exactmac.v1.Transaction.State
...
func init() { file_exactmac_v1_session_proto_init() }
func file_exactmac_v1_session_proto_init() {
	if File_exactmac_v1_session_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_exactmac_v1_session_proto_rawDesc), len(file_exactmac_v1_session_proto_rawDesc)),
			NumEnums:      2,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_exactmac_v1_session_proto_goTypes,
		DependencyIndexes: file_exactmac_v1_session_proto_depIdxs,
		EnumInfos:         file_exactmac_v1_session_proto_enumTypes,
		MessageInfos:      file_exactmac_v1_session_proto_msgTypes,
	}.Build()
	File_exactmac_v1_session_proto = out.File
	file_exactmac_v1_session_proto_goTypes = nil
	file_exactmac_v1_session_proto_depIdxs = nil
}
