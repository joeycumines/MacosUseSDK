...
// 	protoc        (unknown)
// source: macosusesdk/v1/element.proto
...
func (x *Element) Reset() {
	*x = Element{}
	mi := &file_macosusesdk_v1_element_proto_msgTypes[0]
...
func (*Element) Descriptor() ([]byte, []int) {
	return file_macosusesdk_v1_element_proto_rawDescGZIP(), []int{0}
}
...
var File_macosusesdk_v1_element_proto protoreflect.FileDescriptor

const file_macosusesdk_v1_element_proto_rawDesc = "" +
	"\n" +
	"\x1cmacosusesdk/v1/element.proto\x12\x0emacosusesdk.v1\x1a\x1fgoogle/api/field_behavior.proto\x1a\x19google/api/resource.proto\"\xdb\x05\n" +
	"\aElement\x12\x17\n" +
	...
	"\x04path\x18\n" +
	" \x03(\x05B\x03\xe0A\x03R\x04path\x12L\n" +
	"\n" +
	"attributes\x18\v \x03(\v2'.macosusesdk.v1.Element.AttributesEntryB\x03\xe0A\x03R\n" +
	"attributes\x12\x1d\n" +
	"\aactions\x18\f \x03(\tB\x03\xe0A\x03R\aactions\x12;\n" +
	"\x06parent\x18\x0e \x01(\tB#\xe0A\x03\xfaA\x1d\n" +
	"\x1bmacosusesdk.com/ApplicationR\x06parent\x1a=\n" +
	"\x0fAttributesEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01:^\xeaA[\n" +
	"\x17macosusesdk.com/Element\x12-applications/{application}/elements/{element}*\belements2\aelementB\a\n" +
	"\x05_textB\x04\n" +
	"\x02_xB\x04\n" +
	"\x02_yB\b\n" +
	"\x06_widthB\t\n" +
	...
	"\n" +
	"\b_focusedB\xc3\x01\n" +
	"\x12com.macosusesdk.v1B\fElementProtoP\x01ZFgithub.com/joeycumines/MacosUseSDK/gen/go/macosusesdk/v1;macosusesdkv1\xa2\x02\x03MXX\xaa\x02\x0eMacosusesdk.V1\xca\x02\x0eMacosusesdk\\V1\xe2\x02\x1aMacosusesdk\\V1\\GPBMetadata\xea\x02\x0fMacosusesdk::V1b\x06proto3"

var (
	file_macosusesdk_v1_element_proto_rawDescOnce sync.Once
	file_macosusesdk_v1_element_proto_rawDescData []byte
)

func file_macosusesdk_v1_element_proto_rawDescGZIP() []byte {
	file_macosusesdk_v1_element_proto_rawDescOnce.Do(func() {
		file_macosusesdk_v1_element_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_macosusesdk_v1_element_proto_rawDesc), len(file_macosusesdk_v1_element_proto_rawDesc)))
	})
	return file_macosusesdk_v1_element_proto_rawDescData
}

var file_macosusesdk_v1_element_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_macosusesdk_v1_element_proto_goTypes = []any{
	(*Element)(nil), // 0: macosusesdk.v1.Element
	nil,             // 1: macosusesdk.v1.Element.AttributesEntry
}
var file_macosusesdk_v1_element_proto_depIdxs = []int32{
	1, // 0: macosusesdk.v1.Element.attributes:type_name -> macosusesdk.v1.Element.AttributesEntry
...
func init() { file_macosusesdk_v1_element_proto_init() }
func file_macosusesdk_v1_element_proto_init() {
	if File_macosusesdk_v1_element_proto != nil {
		return
	}
	file_macosusesdk_v1_element_proto_msgTypes[0].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_macosusesdk_v1_element_proto_rawDesc), len(file_macosusesdk_v1_element_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_macosusesdk_v1_element_proto_goTypes,
		DependencyIndexes: file_macosusesdk_v1_element_proto_depIdxs,
		MessageInfos:      file_macosusesdk_v1_element_proto_msgTypes,
	}.Build()
	File_macosusesdk_v1_element_proto = out.File
	file_macosusesdk_v1_element_proto_goTypes = nil
	file_macosusesdk_v1_element_proto_depIdxs = nil
}
