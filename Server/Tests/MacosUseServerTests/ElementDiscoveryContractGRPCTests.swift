...
struct ElementDiscoveryContractGRPCTests {
    ...
    func `window discovery traverses only the exact bound AX root`() async throws {
        ...
        let matches = try await fixture.locator.findElements(
            selector: Macosusesdk_Type_ElementSelector.with { $0.role = "AXButton" },
    ...
    func `generated client continuation preserves stable handles without a second force refresh`() async throws {
        ...
        try await withElementDiscoveryClient(harness.service) { client in
            let first: Macosusesdk_V1_FindElementsResponse = try await elementDiscoveryUnary(
                client: client,
            ...
            let second: Macosusesdk_V1_FindElementsResponse = try await elementDiscoveryUnary(
                client: client,
                request: Macosusesdk_V1_FindElementsRequest.with {
                    $0.parent = harness.parent
                    $0.selector.role = "AXButton"
            ...
            let third: Macosusesdk_V1_FindElementsResponse = try await elementDiscoveryUnary(
                client: client,
                request: Macosusesdk_V1_FindElementsRequest.with {
                    $0.parent = harness.parent
                    $0.selector.role = "AXButton"
    ...
    func `generated client rejects ambiguous mutation selector before activation or input`() async throws {
        ...
        try await withElementDiscoveryClient(harness.service) { client in
            do {
                let _: Macosusesdk_V1_ClickElementResponse = try await elementDiscoveryUnary(
                    client: client,
                    request: Macosusesdk_V1_ClickElementRequest.with {
                        $0.parent = harness.parent
                        $0.selector.role = "AXButton"
                        $0.clickType = .single
                    },
