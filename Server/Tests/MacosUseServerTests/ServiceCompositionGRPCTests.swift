...
struct ServiceCompositionGRPCTests {
    ...
    func `installed composition defaults to production operations`() {
        ...
        let serviceSystemType = String(reflecting: type(of: composition.macosUseService.system))
    ...
    func `installed composition injects one coordinator into every physical producer`() {
        ...
        #expect(composition.macosUseService.automationCoordinator === composition.automationCoordinator)
        #expect(composition.macosUseService.elementRegistry === composition.elementRegistry)
        #expect(composition.macosUseService.elementLocator === composition.elementLocator)
        #expect(composition.macosUseService.observationManager === composition.observationManager)
        #expect(composition.macosUseService.macroExecutor === composition.macroExecutor)
        #expect(
            composition.macosUseService.inputTransactionExecutor
        ...
        #expect(composition.macosUseService.sessionManager === composition.sessionManager)
        #expect(composition.macosUseService.scriptExecutor === composition.scriptExecutor)
        #expect(composition.macosUseService.clipboardManager === composition.clipboardManager)
        #expect(composition.macosUseService.clipboardHistoryManager === composition.clipboardHistoryManager)
        ...
        #expect(composition.macosUseService.physicalDesktopMutationGate === composition.automationCoordinator.mutationGate)
    }

    @Test
    func `element resource round trips and rejects a foreign application owner`() async throws {
        let composition = MacosUseServiceComposition(legacyPIDResourceNamesForTests: true)
        ...
        _ = try await composition.elementRegistry.registerElement(
            Macosusesdk_V1_Element.with { $0.role = "foreign" },
            pid: 222,
        )
        ...
        try await withThrowingDiscardingTaskGroup { group in
            ...
            let element: Macosusesdk_V1_Element = try await unary(
                client: client,
                request: Macosusesdk_V1_GetElementRequest.with { $0.name = ownedName },
                descriptor: Macosusesdk_V1_MacosUse.Method.GetElement.descriptor,
            )
            #expect(element.name == ownedName)
            #expect(element.elementID == elementID)

            let actions: Macosusesdk_V1_ElementActions = try await unary(
                client: client,
                request: Macosusesdk_V1_GetElementActionsRequest.with { $0.name = ownedName },
                descriptor: Macosusesdk_V1_MacosUse.Method.GetElementActions.descriptor,
            )
            #expect(!actions.actions.isEmpty)

            let firstPage: Macosusesdk_V1_ListElementsResponse = try await unary(
                client: client,
            ...
            do {
                let _: Macosusesdk_V1_ListElementsResponse = try await unary(
                    client: client,
                    request: Macosusesdk_V1_ListElementsRequest.with {
                        $0.parent = "applications/111"
                        $0.pageSize = 1
            ...
            let secondPage: Macosusesdk_V1_ListElementsResponse = try await unary(
                client: client,
                request: Macosusesdk_V1_ListElementsRequest.with {
                    $0.parent = "applications/111"
                    $0.pageSize = 1
            ...
            var unknownListBytes = try Macosusesdk_V1_ListElementsRequest.with {
                $0.parent = "applications/111"
            }.serializedData()
            unknownListBytes.append(contentsOf: [0xA0, 0x06, 0x01])
            let unknownListRequest = try Macosusesdk_V1_ListElementsRequest(
            ...
            do {
                let _: Macosusesdk_V1_Element = try await unary(
                    client: client,
                    request: Macosusesdk_V1_GetElementRequest.with { $0.name = foreignName },
                    descriptor: Macosusesdk_V1_MacosUse.Method.GetElement.descriptor,
                )
            ...
            var unknownGetBytes = try Macosusesdk_V1_GetElementRequest.with {
                $0.name = ownedName
            }.serializedData()
            unknownGetBytes.append(contentsOf: [0xA0, 0x06, 0x01])
            let unknownGetRequest = try Macosusesdk_V1_GetElementRequest(
            ...
            do {
                let _: Macosusesdk_V1_ElementActions = try await unary(
                    client: client,
                    request: Macosusesdk_V1_GetElementActionsRequest.with { $0.name = foreignName },
                    descriptor: Macosusesdk_V1_MacosUse.Method.GetElementActions.descriptor,
                )
            ...
            var unknownActionsBytes = try Macosusesdk_V1_GetElementActionsRequest.with {
                $0.name = ownedName
            }.serializedData()
            unknownActionsBytes.append(contentsOf: [0xA0, 0x06, 0x01])
            let unknownActionsRequest = try Macosusesdk_V1_GetElementActionsRequest(
    ...
    func `element mutation resolves owner after admission and reaches zero sinks when stale`() async throws {
        ...
        let request = Macosusesdk_V1_WriteElementValueRequest.with {
        ...
        try await withThrowingDiscardingTaskGroup { group in
            ...
            let write = Task {
                let response: Macosusesdk_V1_WriteElementValueResponse = try await unary(
                    client: client,
                    request: request,
                    descriptor: Macosusesdk_V1_MacosUse.Method.WriteElementValue.descriptor,
                )
                return response
            }
    ...
    func `cross-parent element mutation fails before every injected sink`() async throws {
        ...
        try await withThrowingDiscardingTaskGroup { group in
            ...
            let writeRequest = Macosusesdk_V1_WriteElementValueRequest.with {
                $0.parent = "applications/222"
                $0.elementID = elementID
                $0.value = "after"
            }
            do {
                let _: Macosusesdk_V1_WriteElementValueResponse = try await unary(
                    client: client,
            ...
            let actionRequest = Macosusesdk_V1_PerformElementActionRequest.with {
                $0.parent = "applications/222"
                $0.elementID = elementID
                $0.action = "AXPress"
            }
            do {
                let _: Macosusesdk_V1_PerformElementActionResponse = try await unary(
                    client: client,
                    request: actionRequest,
                    descriptor: Macosusesdk_V1_MacosUse.Method.PerformElementAction.descriptor,
                )
            ...
            let clickRequest = Macosusesdk_V1_ClickElementRequest.with {
                $0.parent = "applications/222"
                $0.elementID = elementID
                $0.clickType = .single
            }
            do {
                let _: Macosusesdk_V1_ClickElementResponse = try await unary(
                    client: client,
                    request: clickRequest,
                    descriptor: Macosusesdk_V1_MacosUse.Method.ClickElement.descriptor,
                )
    ...
    func `WriteElementValue returns converged readback from the exact owned element`() async throws {
        ...
        try await withThrowingDiscardingTaskGroup { group in
            ...
            let response: Macosusesdk_V1_WriteElementValueResponse = try await unary(
                client: client,
                request: Macosusesdk_V1_WriteElementValueRequest.with {
                    $0.parent = "applications/2468"
                    $0.elementID = elementID
                    $0.value = "after"
                },
    ...
    func `PerformElementAction uses injected AX sink and returns the exact live element`() async throws {
        ...
        try await withThrowingDiscardingTaskGroup { group in
            ...
            let response: Macosusesdk_V1_PerformElementActionResponse = try await unary(
                client: client,
                request: Macosusesdk_V1_PerformElementActionRequest.with {
    ...
    func `C16 PerformElementAction maps a failed AX action to failedPrecondition`() async throws {
        ...
        let elementID = try await composition.elementRegistry.registerElement(
            Macosusesdk_V1_Element.with { $0.role = "AXButton" },
            axElement: AXUIElementCreateSystemWide(),
            pid: 9754,
        )
    ...
    func `WriteClipboard uses installed pasteboard and rejects invalid or drained work before mutation`() async throws {
        ...
        let validRequest = Macosusesdk_V1_WriteClipboardRequest.with {
            $0.content = Macosusesdk_V1_ClipboardContent.with {
                $0.type = .text
        ...
        try await withThrowingDiscardingTaskGroup { group in
            ...
            let response: Macosusesdk_V1_WriteClipboardResponse = try await unary(
                client: client,
            ...
            let mismatchedRequest = Macosusesdk_V1_WriteClipboardRequest.with {
                $0.content = Macosusesdk_V1_ClipboardContent.with {
                    $0.type = .url
            ...
            do {
                let _: Macosusesdk_V1_WriteClipboardResponse = try await unary(
                    client: client,
    ...
    func `concurrent GetClipboard RPCs cannot overlap pasteboard access`() async throws {
        ...
        let request = Macosusesdk_V1_GetClipboardRequest.with {
            $0.name = "clipboard"
        }
        ...
        try await withThrowingDiscardingTaskGroup { group in
            ...
            let first = Task {
                let response: Macosusesdk_V1_Clipboard = try await unary(
                    client: client,
                    request: request,
                    descriptor: Macosusesdk_V1_MacosUse.Method.GetClipboard.descriptor,
                )
                return response
            }
    ...
    func `serialized MoveWindow mutates injected state and returns observed bounds`() async throws {
        ...
        try await withThrowingDiscardingTaskGroup { group in
            ...
            let before: Macosusesdk_V1_ListWindowsResponse = try await unary(
                client: client,
                request: Macosusesdk_V1_ListWindowsRequest.with { $0.parent = parent },
            ...
            let mutation: Macosusesdk_V1_Window = try await unary(
                client: client,
    ...
    func `concurrent CreateInput RPCs remain FIFO across suspended execution`() async throws {
        ...
        try await withThrowingDiscardingTaskGroup { group in
            ...
            let first = Task {
                let response: Macosusesdk_V1_Input = try await unary(
                    client: client,
    ...
    func `OpenApplication holds the shared gate through identity and state publication`() async throws {
        ...
        let coordinator = AutomationCoordinator(
            ...
            applicationOpenExecutor: { applicationURL, _, mode in
                ...
                return MacosUseSDK.AppOpenerResult(
                    pid: pid,
                    appName: "Calculator",
        ...
        try await withThrowingDiscardingTaskGroup { group in
            ...
            let open = Task {
                let response: Macosusesdk_V1_OpenApplicationResponse = try await unary(
                    client: client,
                    request: Macosusesdk_V1_OpenApplicationRequest.with {
    ...
    func `MoveWindow shares the injected physical desktop gate with CreateInput`() async throws {
        ...
        try await withThrowingDiscardingTaskGroup { group in
            ...
            let parent = "applications/\(pid)"
            let listed: Macosusesdk_V1_ListWindowsResponse = try await unary(
                client: client,
                request: Macosusesdk_V1_ListWindowsRequest.with { $0.parent = parent },
                descriptor: Macosusesdk_V1_MacosUse.Method.ListWindows.descriptor,
            )
            ...
            let move = Task {
                let response: Macosusesdk_V1_Window = try await unary(
                    client: client,
                    request: Macosusesdk_V1_MoveWindowRequest.with {
                        $0.name = windowName
                        $0.x = expectedOrigin.x
    ...
    func `retained input semantics execute through generated CreateInput client`() async throws {
        ...
        let coordinator = AutomationCoordinator(
            ...
            inputKeyResolver: { key in
                ...
                return ResolvedInputKey(
                    keyCode: MacosUseSDK.KEY_RETURN,
                    sourceIdentity: nil,
                )
            },
            ...
            inputActionExecutor: { action, route, _ in
                ...
                try await MacosUseSDK.executeInputAction(
                    action,
        ...
        try await withThrowingDiscardingTaskGroup { group in
            ...
            let click: Macosusesdk_V1_Input = try await unary(
                client: client,
            ...
            let typeText: Macosusesdk_V1_Input = try await unary(
                client: client,
                request: Macosusesdk_V1_CreateInputRequest.with {
                    $0.parent = applicationName
                    $0.inputID = "type"
                    $0.input.target.application = applicationName
                    $0.input.action.typeText = Macosusesdk_V1_TextInput.with {
                        $0.text = "ab"
                        $0.charDelay = 0.125
                    }
                },
            ...
            let key: Macosusesdk_V1_Input = try await unary(
                client: client,
                request: Macosusesdk_V1_CreateInputRequest.with {
                    $0.parent = "applications/-"
                    $0.inputID = "key"
                    $0.input.target.desktop = true
                    $0.input.action.pressKey = Macosusesdk_V1_KeyPress.with {
                        $0.key = "return"
            ...
            let move: Macosusesdk_V1_Input = try await unary(
                client: client,
                request: Macosusesdk_V1_CreateInputRequest.with {
                    $0.parent = "applications/-"
                    $0.inputID = "move"
                    $0.input.target.desktop = true
                    $0.input.action.moveMouse = Macosusesdk_V1_MouseMove.with {
                        $0.position = Macosusesdk_Type_Point.with {
                            $0.x = 30
                            $0.y = 40
                        }
            ...
            let drag: Macosusesdk_V1_Input = try await unary(
                client: client,
                request: Macosusesdk_V1_CreateInputRequest.with {
                    $0.parent = "applications/-"
                    $0.inputID = "drag"
                    $0.input.target.desktop = true
                    $0.input.action.drag = Macosusesdk_V1_MouseDrag.with {
                        $0.startPosition = Macosusesdk_Type_Point.with { $0.x = 1; $0.y = 2 }
                        $0.endPosition = Macosusesdk_Type_Point.with { $0.x = 5; $0.y = 6 }
                        $0.path = [
                            Macosusesdk_Type_Point.with { $0.x = 1; $0.y = 2 },
                            Macosusesdk_Type_Point.with { $0.x = 3; $0.y = 9 },
                            Macosusesdk_Type_Point.with { $0.x = 5; $0.y = 6 },
                        ]
                        $0.button = .right
                        $0.duration = 1.5
                        $0.modifiers = [.shift]
            ...
            let scroll: Macosusesdk_V1_Input = try await unary(
                client: client,
                request: Macosusesdk_V1_CreateInputRequest.with {
                    $0.parent = "applications/-"
                    $0.inputID = "scroll"
            ...
            let hover: Macosusesdk_V1_Input = try await unary(
                client: client,
                request: Macosusesdk_V1_CreateInputRequest.with {
                    $0.parent = "applications/-"
                    $0.inputID = "hover"
                    $0.input.target.desktop = true
                    $0.input.action.hover = Macosusesdk_V1_Hover.with {
                        $0.position = Macosusesdk_Type_Point.with {
                            $0.x = 300
                            $0.y = 400
                        }
            ...
            if case let .pressKeyCodeHold(keyCode, modifiers, duration) = actions[2] {
                #expect(keyCode == MacosUseSDK.KEY_RETURN)
    ...
    func `unknown removed input intent fails before execution and state insertion`() async throws {
        ...
        try await withThrowingDiscardingTaskGroup { group in
            ...
            let knownAction = Macosusesdk_V1_InputAction.with {
                $0.click = Macosusesdk_V1_MouseClick.with {
                    $0.position = Macosusesdk_Type_Point.with { $0.x = 10; $0.y = 20 }
                }
            }
            ...
            let action = try Macosusesdk_V1_InputAction(serializedBytes: actionBytes)
            do {
                let _: Macosusesdk_V1_Input = try await unary(
                    client: client,
                    request: Macosusesdk_V1_CreateInputRequest.with {
                        $0.parent = "applications/-"
            ...
            let inputState = await composition.macosUseService.stateStore.currentState()
...
private actor BlockingApplicationOpenRecorder {
    struct Call: Equatable, Sendable {
        ...
        let background: Bool
        let mode: MacosUseSDK.AppLaunchMode
    }
    ...
    func open(
    ...
    ) async -> MacosUseSDK.AppOpenerResult {
        ...
        let action: MacosUseSDK.AppOpenAction = switch mode {
...
private actor InputActionCapture {
    ...
    func snapshot() -> [MacosUseSDK.InputAction] {
        actions
    }
}
...
private actor CompositionClipboardPasteboard: ClipboardPasteboard {
    enum Call: Equatable, Sendable {
        case clear
        case write(Macosusesdk_V1_ContentType)
        case read
    }

    private var calls: [Call] = []
    private var changeCountValue = 0
    private var clipboard = Macosusesdk_V1_Clipboard.with {
        $0.name = "clipboard"
    }
    ...
    func clear() {
        calls.append(.clear)
        changeCountValue += 1
        clipboard = Macosusesdk_V1_Clipboard.with {
            $0.name = "clipboard"
        }
    }
...
private func pollUntilWindow(
    ...
    while true {
        let window: Macosusesdk_V1_Window = try await unary(
            client: client,
            request: Macosusesdk_V1_GetWindowRequest.with { $0.name = name },
...
private func createInjectedInputRequest(
    ...
    Macosusesdk_V1_CreateInputRequest.with {
        ...
        $0.input = Macosusesdk_V1_Input.with {
            ...
            $0.action = Macosusesdk_V1_InputAction.with {
                $0.moveMouse = Macosusesdk_V1_MouseMove.with {
                    $0.position = Macosusesdk_Type_Point.with {
                        $0.x = x
                        $0.y = 100
                    }
