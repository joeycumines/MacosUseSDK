...
final class MacroExecutorTests: XCTestCase {
        ...
        let macro = Macosusesdk_V1_Macro.with {
            ...
            $0.actions = [
                Macosusesdk_V1_MacroAction.with {
                    $0.input = Macosusesdk_V1_InputAction.with {
    ...
    func testStaleApplicationIdentityIsRejectedAtEveryActionBoundary() async throws {
        ...
        let macro = Macosusesdk_V1_Macro.with {
            ...
            $0.actions = [
                Macosusesdk_V1_MacroAction.with {
                    $0.wait = Macosusesdk_V1_WaitAction.with { $0.duration = 0 }
                },
            ]
        }
            ...
            $0.actions = [
                Macosusesdk_V1_MacroAction.with {
                    ...
                    $0.conditional.thenActions = [
                        Macosusesdk_V1_MacroAction.with {
                            $0.input.moveMouse.position = Macosusesdk_Type_Point.with {
                                $0.x = 10
                                $0.y = 20
                            }
                        },
    ...
    func testNegativeLoopCountAndWaitDurationFailWithoutTrapping() async throws {
        ...
        let invalidWait = Macosusesdk_V1_Macro.with {
            $0.name = "macros/invalid-wait"
            $0.actions = [
                Macosusesdk_V1_MacroAction.with {
                    $0.wait = Macosusesdk_V1_WaitAction.with {
                        $0.duration = -1
                    }
                },
            ]
...
private func makeNestedLoopMacro(count: Int32 = .max) -> Macosusesdk_V1_Macro {
