...
struct ApplicationContractGRPCTests {
    ...
    func `bundle discovery preserves exact locations and binds pagination to the query`() async throws {
        ...
        let composition = MacosUseServiceComposition(applicationCatalogProvider: catalog)

        try await withApplicationClient(composition) { client in
            let firstPage: Macosusesdk_V1_ListApplicationBundlesResponse = try await applicationUnary(
                client: client,
            ...
            let secondPage: Macosusesdk_V1_ListApplicationBundlesResponse = try await applicationUnary(
                client: client,
                request: Macosusesdk_V1_ListApplicationBundlesRequest.with {
                    $0.pageSize = 1
            ...
            let basic: Macosusesdk_V1_ApplicationBundle = try await applicationUnary(
                client: client,
                request: Macosusesdk_V1_GetApplicationBundleRequest.with {
                    $0.name = firstPage.applicationBundles[0].name
                },
                descriptor: Macosusesdk_V1_MacosUse.Method.GetApplicationBundle.descriptor,
            )
            #expect(basic.bundleURL.isEmpty)
            #expect(basic.version.isEmpty)

            do {
                let _: Macosusesdk_V1_ListApplicationBundlesResponse = try await applicationUnary(
                    client: client,
                    request: Macosusesdk_V1_ListApplicationBundlesRequest.with {
                        $0.pageSize = 1
                        $0.pageToken = firstPage.nextPageToken
    ...
    func `bundle list rejects malformed query and preserved unknown intent`() async throws {
        ...
        try await withApplicationClient(composition) { client in
            let invalidRequests: [Macosusesdk_V1_ListApplicationBundlesRequest] = [
                .with { $0.pageSize = -1 },
            ...
            var bytes = try Macosusesdk_V1_ListApplicationBundlesRequest().serializedData()
            bytes.append(contentsOf: [0xA0, 0x06, 0x01])
            let unknown = try Macosusesdk_V1_ListApplicationBundlesRequest(serializedBytes: bytes)
            do {
                let _: Macosusesdk_V1_ListApplicationBundlesResponse = try await applicationUnary(
                    client: client,
                    request: unknown,
    ...
    func `running list discovers preexisting exact process instances`() async throws {
        ...
        try await withApplicationClient(composition) { client in
            let basic: Macosusesdk_V1_ListApplicationsResponse = try await applicationUnary(
                client: client,
            ...
            let full: Macosusesdk_V1_Application = try await applicationUnary(
                client: client,
                request: Macosusesdk_V1_GetApplicationRequest.with {
                    $0.name = exactName
                    $0.view = .full
                },
            ...
            catalog.setRunning([])
            let retained: Macosusesdk_V1_ListApplicationsResponse = try await applicationUnary(
                client: client,
                request: Macosusesdk_V1_ListApplicationsRequest.with {
                    $0.orderBy = "display_name"
                },
            ...
            let pruned: Macosusesdk_V1_ListApplicationsResponse = try await applicationUnary(
                client: client,
                request: Macosusesdk_V1_ListApplicationsRequest.with {
                    $0.orderBy = "display_name"
                },
    ...
    func `running list executes only its documented filter and ordering grammar`() async throws {
        ...
        try await withApplicationClient(composition) { client in
            for orderBy in ["name", "pid", "display_name", "bundle_id", "active", "active desc"] {
                let response: Macosusesdk_V1_ListApplicationsResponse = try await applicationUnary(
                    client: client,
                    request: Macosusesdk_V1_ListApplicationsRequest.with { $0.orderBy = orderBy },
                    descriptor: Macosusesdk_V1_MacosUse.Method.ListApplications.descriptor,
                )
                #expect(response.applications.count == 2)
            }

            let byDisplayName: Macosusesdk_V1_ListApplicationsResponse = try await applicationUnary(
                client: client,
                request: Macosusesdk_V1_ListApplicationsRequest.with {
            ...
            let byBundleID: Macosusesdk_V1_ListApplicationsResponse = try await applicationUnary(
                client: client,
                request: Macosusesdk_V1_ListApplicationsRequest.with {
            ...
            for invalidRequest in [
                Macosusesdk_V1_ListApplicationsRequest.with { $0.filter = "name = \"Alpha\"" },
                Macosusesdk_V1_ListApplicationsRequest.with { $0.orderBy = "unknown" },
            ] {
                do {
                    let _: Macosusesdk_V1_ListApplicationsResponse = try await applicationUnary(
                        client: client,
    ...
    func `opaque application parents round trip through windows and elements and reject PID reuse`() async throws {
        ...
        try await withApplicationClient(composition) { client in
            let runningResponse: Macosusesdk_V1_ListApplicationsResponse = try await applicationUnary(
                client: client,
            ...
            let windows: Macosusesdk_V1_ListWindowsResponse = try await applicationUnary(
                client: client,
                request: Macosusesdk_V1_ListWindowsRequest.with { $0.parent = applicationName },
            ...
            do {
                let _: Macosusesdk_V1_ListWindowsResponse = try await applicationUnary(
                    client: client,
            ...
            let elements: Macosusesdk_V1_ListElementsResponse = try await applicationUnary(
                client: client,
                request: Macosusesdk_V1_ListElementsRequest.with { $0.parent = applicationName },
                descriptor: Macosusesdk_V1_MacosUse.Method.ListElements.descriptor,
            )
            #expect(elements.elements.map(\.name) == [elementName])
            let element: Macosusesdk_V1_Element = try await applicationUnary(
                client: client,
                request: Macosusesdk_V1_GetElementRequest.with { $0.name = elementName },
            ...
            let replacementResponse: Macosusesdk_V1_ListApplicationsResponse = try await applicationUnary(
                client: client,
                request: Macosusesdk_V1_ListApplicationsRequest(),
                descriptor: Macosusesdk_V1_MacosUse.Method.ListApplications.descriptor,
            )
            ...
            let replacementElements: Macosusesdk_V1_ListElementsResponse = try await applicationUnary(
                client: client,
                request: Macosusesdk_V1_ListElementsRequest.with { $0.parent = replacementName },
                descriptor: Macosusesdk_V1_MacosUse.Method.ListElements.descriptor,
            )
            ...
            do {
                let _: Macosusesdk_V1_Element = try await applicationUnary(
                    client: client,
                    request: Macosusesdk_V1_GetElementRequest.with { $0.name = elementName },
                    descriptor: Macosusesdk_V1_MacosUse.Method.GetElement.descriptor,
                )
    ...
    func `open resolves one exact bundle resource and publishes exact process identity`() async throws {
        ...
        try await withApplicationClient(composition) { client in
            let response: Macosusesdk_V1_OpenApplicationResponse = try await applicationUnary(
                client: client,
            ...
            do {
                let _: Macosusesdk_V1_OpenApplicationResponse = try await applicationUnary(
                    client: client,
                    request: Macosusesdk_V1_OpenApplicationRequest.with { $0.name = "Example" },
                    descriptor: Macosusesdk_V1_MacosUse.Method.OpenApplication.descriptor,
                )
    ...
    func `activation converges on the same exact process and stale identity reaches no sink`() async throws {
        ...
        try await withApplicationClient(composition) { client in
            ...
            let response: Macosusesdk_V1_ActivateApplicationResponse = try await applicationUnary(
                client: client,
                request: Macosusesdk_V1_ActivateApplicationRequest.with { $0.name = name },
                descriptor: Macosusesdk_V1_MacosUse.Method.ActivateApplication.descriptor,
            )
            ...
            do {
                let _: Macosusesdk_V1_ActivateApplicationResponse = try await applicationUnary(
                    client: client,
                    request: Macosusesdk_V1_ActivateApplicationRequest.with {
    ...
    func `close rejects PID reuse without a termination sink`() async throws {
        ...
        let staleApplication = Macosusesdk_V1_Application.with {
        ...
        try await withApplicationClient(composition) { client in
            do {
                let _: Macosusesdk_V1_CloseApplicationResponse = try await applicationUnary(
                    client: client,
                    request: Macosusesdk_V1_CloseApplicationRequest.with {
                        $0.name = staleApplication.name
                        $0.force = true
                    },
                    descriptor: Macosusesdk_V1_MacosUse.Method.CloseApplication.descriptor,
                )
