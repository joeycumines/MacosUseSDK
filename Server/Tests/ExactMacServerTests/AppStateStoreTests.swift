...
final class AppStateStoreTests: XCTestCase {
    func testAddAndGetTarget() async {
        ...
        let target = Exactmac_V1_Application.with {
    ...
    func testListTargets() async {
        let store = AppStateStore()
        let target1 = Exactmac_V1_Application.with {
            $0.name = "applications/123"
            $0.pid = 123
            $0.displayName = "App1"
        }
        let target2 = Exactmac_V1_Application.with {
    ...
    func testApplicationProcessGenerationLeaseRejectsIncoherentRowsAndPIDReuse() async {
        ...
        let incoherent = Exactmac_V1_Application.with {
    ...
    private func makeDesktopTarget() -> Exactmac_V1_InputTarget {
        .with { $0.desktop = true }
    }
}
