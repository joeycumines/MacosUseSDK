...
struct InputTargetAuthorityGRPCTests {
    ...
    func `legacy numeric PID authority is explicit and production rejects it`() async throws {
        ...
        let directService = ExactMacService(
        ...
        let production = ExactMacServiceComposition(
            system: system,
        ...
        let legacy = ExactMacServiceComposition(
            system: system,
...
private func createTargetAuthorityInput(
    ...
    request: Exactmac_V1_CreateInputRequest,
    ...
    try await client.unary(
        ...
        serializer: ProtobufSerializer<Exactmac_V1_CreateInputRequest>(),
        deserializer: ProtobufDeserializer<Exactmac_V1_Input>(),
        options: .defaults,
    ) { response in
