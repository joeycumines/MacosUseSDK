...
final class ElementLocatorMatchingSelectorTests: XCTestCase {
    ...
    func testPositionSelectorUsesElementCenter() async {
        ...
        let selectorMatchesCenter = Exactmac_Type_ElementSelector.with {
            $0.position = Exactmac_Type_PositionSelector.with {
                $0.x = 150
                $0.y = 150
                $0.tolerance = 1
        ...
        let selectorMatchesTopLeft = Exactmac_Type_ElementSelector.with {
            $0.position = Exactmac_Type_PositionSelector.with {
                $0.x = 100
                $0.y = 100
                $0.tolerance = 1
    ...
    func testRoleSelectorMatchesCanonicalRole() async {
        ...
        let selector = Exactmac_Type_ElementSelector.with { $0.role = "AXTextArea" }
        let matches = await locator.matchesSelector(element, selector: selector)
    ...
    func testRoleSelectorWithDescriptionMatchesCanonicalElement() async {
        ...
        let selector = Exactmac_Type_ElementSelector.with { $0.role = "AXTextArea (text entry area)" }
        let matches = await locator.matchesSelector(element, selector: selector)
    ...
    func testNOTOperatorInvertsMatch() async {
        let button = Exactmac_V1_Element.with {
            $0.role = "AXButton"
            $0.text = "Submit"
        }
        let staticText = Exactmac_V1_Element.with {
            $0.role = "AXStaticText"
            $0.text = "Label"
        }
    ...
    func testNOTOperatorWithCompoundInner() async {
        ...
        let buttonWithSubmit = Exactmac_V1_Element.with {
            $0.role = "AXButton"
            $0.text = "Submit"
        }
        let buttonWithCancel = Exactmac_V1_Element.with {
            $0.role = "AXButton"
            $0.text = "Cancel"
        }
    ...
    func testOROperatorAnyMatch() async {
        ...
        let link = Exactmac_V1_Element.with {
            $0.role = "AXLink"
        }
        let text = Exactmac_V1_Element.with {
            $0.role = "AXStaticText"
        }
    ...
    func testRoleMatchingCaseInsensitive() async {
        ...
        let lowercaseSelector = Exactmac_Type_ElementSelector.with {
            $0.role = "axbutton"
        }
        let uppercaseSelector = Exactmac_Type_ElementSelector.with {
            $0.role = "AXBUTTON"
        }
    ...
    func testTextExactMatch() async {
        ...
        let exactSelector = Exactmac_Type_ElementSelector.with {
            $0.text = "Hello World"
        }
        let partialSelector = Exactmac_Type_ElementSelector.with {
            $0.text = "Hello"
        }
