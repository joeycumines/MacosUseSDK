...
final class ObservationMethodsTests: XCTestCase {
    ...
    private func makeCreateObservationRequest(
        _ msg: Exactmac_V1_CreateObservationRequest,
    ) -> GRPCCore.ServerRequest<Exactmac_V1_CreateObservationRequest> {
    ...
    private func observationMetadata(
        ...
        XCTAssertEqual(
            ...
            "type.googleapis.com/exactmac.v1.Observation",
        )
        return try Exactmac_V1_Observation(serializedBytes: operation.metadata.value)
    }

    private func makeGetObservationRequest(
        _ msg: Exactmac_V1_GetObservationRequest,
    ) -> GRPCCore.ServerRequest<Exactmac_V1_GetObservationRequest> {
        GRPCCore.ServerRequest(metadata: GRPCCore.Metadata(), message: msg)
    }

    private func makeListObservationsRequest(
        _ msg: Exactmac_V1_ListObservationsRequest,
    ) -> GRPCCore.ServerRequest<Exactmac_V1_ListObservationsRequest> {
        GRPCCore.ServerRequest(metadata: GRPCCore.Metadata(), message: msg)
    }

    private func makeCancelObservationRequest(
        _ msg: Exactmac_V1_CancelObservationRequest,
    ) -> GRPCCore.ServerRequest<Exactmac_V1_CancelObservationRequest> {
        GRPCCore.ServerRequest(metadata: GRPCCore.Metadata(), message: msg)
    }

    private func makeStreamObservationsRequest(
        _ msg: Exactmac_V1_StreamObservationsRequest,
    ) -> GRPCCore.ServerRequest<Exactmac_V1_StreamObservationsRequest> {
        GRPCCore.ServerRequest(metadata: GRPCCore.Metadata(), message: msg)
    }
    ...
    private func makeGetObservationContext() -> GRPCCore.ServerContext {
        GRPCCore.ServerContext(
            descriptor: Exactmac_V1_ExactMac.Method.GetObservation.descriptor,
            remotePeer: "in-process:tests",
            localPeer: "in-process:server",
            cancellation: GRPCCore.ServerContext.RPCCancellationHandle(),
        )
    ...
    private func makeCancelObservationContext() -> GRPCCore.ServerContext {
        GRPCCore.ServerContext(
            descriptor: Exactmac_V1_ExactMac.Method.CancelObservation.descriptor,
            remotePeer: "in-process:tests",
            localPeer: "in-process:server",
            cancellation: GRPCCore.ServerContext.RPCCancellationHandle(),
        )
    ...
    private func createTestObservation(
        ...
        type: Exactmac_V1_ObservationType = .windowChanges,
        pid: pid_t = 12345,
    ) async -> Exactmac_V1_Observation {
        do {
            ...
            return Exactmac_V1_Observation()
        }
    }
    ...
    func testCreateObservationWithAttributeChangesType() async throws {
        ...
        observation.filter = Exactmac_V1_ObservationFilter.with {
    ...
    func testGetObservationRetrievesObservationByName() async throws {
        ...
        var request = Exactmac_V1_GetObservationRequest()
    ...
    func testGetObservationEmptyNameReturnsValidationError() async throws {
        let request = Exactmac_V1_GetObservationRequest()
        // name is empty
    ...
    func testListObservationsReturnsObservationsForParent() async throws {
        ...
        var request = Exactmac_V1_ListObservationsRequest()
    ...
    func testCancelObservationChangesStateToCancelled() async throws {
        ...
        var request = Exactmac_V1_CancelObservationRequest()
        request.name = obsName
    ...
    func testCancelObservationEmptyNameReturnsValidationError() async throws {
        let request = Exactmac_V1_CancelObservationRequest()
        // name is empty
    ...
    func testStreamObservationsRequiresExistingObservation() async throws {
        var request = Exactmac_V1_StreamObservationsRequest()
    ...
    func testStreamObservationsEmptyNameReturnsValidationError() async throws {
        let request = Exactmac_V1_StreamObservationsRequest()
        // name is empty
    ...
    func testObservationPublicationReconciliationDistinguishesDeletionFromTerminalLoss() async {
        ...
        await ExactMacService.reconcileObservationPublication(
            .discarded,
    ...
    func testObservationLifecycleActiveState() async throws {
        ...
        var obs: Exactmac_V1_Observation?
        for _ in 0 ..< 100 {
    ...
    func testObservationStateValues() {
        XCTAssertEqual(Exactmac_V1_Observation.State.unspecified.rawValue, 0)
        XCTAssertEqual(Exactmac_V1_Observation.State.pending.rawValue, 1)
        XCTAssertEqual(Exactmac_V1_Observation.State.active.rawValue, 2)
        XCTAssertEqual(Exactmac_V1_Observation.State.completed.rawValue, 3)
        XCTAssertEqual(Exactmac_V1_Observation.State.cancelled.rawValue, 4)
        XCTAssertEqual(Exactmac_V1_Observation.State.failed.rawValue, 5)
    }

    func testObservationTypeValues() {
        XCTAssertEqual(Exactmac_V1_ObservationType.unspecified.rawValue, 0)
        XCTAssertEqual(Exactmac_V1_ObservationType.elementChanges.rawValue, 1)
        XCTAssertEqual(Exactmac_V1_ObservationType.windowChanges.rawValue, 2)
        XCTAssertEqual(Exactmac_V1_ObservationType.applicationChanges.rawValue, 3)
        XCTAssertEqual(Exactmac_V1_ObservationType.attributeChanges.rawValue, 4)
        XCTAssertEqual(Exactmac_V1_ObservationType.treeChanges.rawValue, 5)
    }

    // MARK: - Observation Filter Tests

    func testObservationFilterConstruction() {
        let filter = Exactmac_V1_ObservationFilter.with {
            $0.pollInterval = 2.5
            $0.visibleOnly = true
            $0.roles = ["AXButton", "AXTextField"]
            $0.attributes = ["AXValue", "AXTitle"]
    ...
    func testObservationFilterDefaultValues() {
        let filter = Exactmac_V1_ObservationFilter()
    ...
    func testObservationEventConstruction() {
        let event = Exactmac_V1_ObservationEvent.with {
    ...
    func testWindowEventTypeValues() {
        XCTAssertEqual(Exactmac_V1_WindowEvent.WindowEventType.unspecified.rawValue, 0)
        XCTAssertEqual(Exactmac_V1_WindowEvent.WindowEventType.created.rawValue, 1)
        XCTAssertEqual(Exactmac_V1_WindowEvent.WindowEventType.destroyed.rawValue, 2)
        XCTAssertEqual(Exactmac_V1_WindowEvent.WindowEventType.moved.rawValue, 3)
        XCTAssertEqual(Exactmac_V1_WindowEvent.WindowEventType.resized.rawValue, 4)
        XCTAssertEqual(Exactmac_V1_WindowEvent.WindowEventType.minimized.rawValue, 5)
        XCTAssertEqual(Exactmac_V1_WindowEvent.WindowEventType.restored.rawValue, 6)
        XCTAssertEqual(Exactmac_V1_WindowEvent.WindowEventType.focused.rawValue, 7)
        XCTAssertEqual(Exactmac_V1_WindowEvent.WindowEventType.hidden.rawValue, 8)
        XCTAssertEqual(Exactmac_V1_WindowEvent.WindowEventType.shown.rawValue, 9)
    }
