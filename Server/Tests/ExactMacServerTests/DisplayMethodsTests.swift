...
final class DisplayMethodsTests: XCTestCase {
    ...
    private func makeListDisplaysRequest(_ msg: Exactmac_V1_ListDisplaysRequest = Exactmac_V1_ListDisplaysRequest()) -> GRPCCore.ServerRequest<Exactmac_V1_ListDisplaysRequest> {
        GRPCCore.ServerRequest(metadata: GRPCCore.Metadata(), message: msg)
    }

    private func makeGetDisplayRequest(_ msg: Exactmac_V1_GetDisplayRequest) -> GRPCCore.ServerRequest<Exactmac_V1_GetDisplayRequest> {
        GRPCCore.ServerRequest(metadata: GRPCCore.Metadata(), message: msg)
    }
    ...
    func testDisplayNameForCursorRejectsMissingActiveDisplay() {
        XCTAssertThrowsError(
            try ExactMacService.displayNameForCursor(
                cursorLocation: .zero,
                activeDisplays: [],
            ),
        ) { error in
    ...
    func testListDisplaysPaginationWithSmallPageSize() async throws {
        ...
        var paginatedRequest = Exactmac_V1_ListDisplaysRequest()
    ...
    func testGetDisplayReturnsValidDisplay() async throws {
        ...
        var getRequest = Exactmac_V1_GetDisplayRequest()
    ...
    func testGetDisplayEmptyName() async throws {
        let getRequest = Exactmac_V1_GetDisplayRequest()
    ...
    private func makeCaptureCursorPositionRequest(_ msg: Exactmac_V1_CaptureCursorPositionRequest = Exactmac_V1_CaptureCursorPositionRequest()) -> GRPCCore.ServerRequest<Exactmac_V1_CaptureCursorPositionRequest> {
        GRPCCore.ServerRequest(metadata: GRPCCore.Metadata(), message: msg)
    }
    ...
    func testListDisplaysInvalidPageToken() async throws {
        var request = Exactmac_V1_ListDisplaysRequest()
