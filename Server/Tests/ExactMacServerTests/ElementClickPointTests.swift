...
/// Unit tests for ExactMacService.elementClickPoint center calculation.
///
...
final class ElementClickPointTests: XCTestCase {
    ...
    func testClickPoint_standardElement_returnsCenter() throws {
        ...
        let point = try ExactMacService.elementClickPoint(element)
    ...
    func testClickPoint_zeroWidthAndHeight_throwsFailedPrecondition() throws {
        ...
        XCTAssertThrowsError(try ExactMacService.elementClickPoint(element)) { error in
...
final class ElementClickPointScreenTests: XCTestCase {
    func testClickPointOnScreen_centerWithinMainDisplay_isTrue() {
        ...
        XCTAssertTrue(ExactMacService.elementClickPointIsOnScreen(element))
    }
    ...
    func testClickPointOnScreen_farOffScreen_isFalse() {
        ...
        XCTAssertFalse(ExactMacService.elementClickPointIsOnScreen(element))
    }
