...
final class ScriptingMethodsTests: XCTestCase {
    ...
    private func makeAppleScriptRequest(
        _ msg: Exactmac_V1_ExecuteAppleScriptRequest,
    ) -> GRPCCore.ServerRequest<Exactmac_V1_ExecuteAppleScriptRequest> {
        GRPCCore.ServerRequest(metadata: GRPCCore.Metadata(), message: msg)
    }

    private func makeJavaScriptRequest(
        _ msg: Exactmac_V1_ExecuteJavaScriptRequest,
    ) -> GRPCCore.ServerRequest<Exactmac_V1_ExecuteJavaScriptRequest> {
        GRPCCore.ServerRequest(metadata: GRPCCore.Metadata(), message: msg)
    }

    private func makeShellCommandRequest(
        _ msg: Exactmac_V1_ExecuteShellCommandRequest,
    ) -> GRPCCore.ServerRequest<Exactmac_V1_ExecuteShellCommandRequest> {
        GRPCCore.ServerRequest(metadata: GRPCCore.Metadata(), message: msg)
    }

    private func makeValidateScriptRequest(
        _ msg: Exactmac_V1_ValidateScriptRequest,
    ) -> GRPCCore.ServerRequest<Exactmac_V1_ValidateScriptRequest> {
        GRPCCore.ServerRequest(metadata: GRPCCore.Metadata(), message: msg)
    }
    ...
    private func makeValidateScriptContext() -> GRPCCore.ServerContext {
        GRPCCore.ServerContext(
            descriptor: Exactmac_V1_ExactMac.Method.ValidateScript.descriptor,
            remotePeer: "in-process:tests",
            localPeer: "in-process:server",
            cancellation: GRPCCore.ServerContext.RPCCancellationHandle(),
        )
    ...
    func testExecuteAppleScriptWithEmptyScript() async throws {
        let request = Exactmac_V1_ExecuteAppleScriptRequest()
    ...
    func testExecuteJavaScriptWithEmptyScript() async throws {
        let request = Exactmac_V1_ExecuteJavaScriptRequest()
    ...
    func testExecuteShellCommandHonorsRPCCancellation() async throws {
        let marker = FileManager.default.temporaryDirectory
            .appendingPathComponent("exactmac-rpc-cancel-\(UUID().uuidString)")
    ...
    func testExecuteShellCommandWithEmptyCommand() async throws {
        let request = Exactmac_V1_ExecuteShellCommandRequest()
    ...
    func testValidateScriptAppleScriptValid() async throws {
        let request = Exactmac_V1_ValidateScriptRequest.with {
            $0.script = "return 42"
            $0.type = .applescript
        }
