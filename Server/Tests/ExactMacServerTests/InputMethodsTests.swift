...
final class InputMethodsTests: XCTestCase {
    ...
    func testInputActionClickConstruction() {
        ...
        click.position = Exactmac_Type_Point.with {
            $0.x = 100.0
            $0.y = 200.0
        }
    ...
    func testInputActionMoveMouseConstruction() {
        var action = Exactmac_V1_InputAction()
        var move = Exactmac_V1_MouseMove()
        move.position = Exactmac_Type_Point.with {
            $0.x = 500.0
            $0.y = 600.0
        }
    ...
    func testMouseClickTypeLeft() {
        let clickType = Exactmac_V1_MouseClick.ClickType.left
        XCTAssertEqual(clickType.rawValue, 1)
    }

    func testMouseClickTypeRight() {
        let clickType = Exactmac_V1_MouseClick.ClickType.right
        XCTAssertEqual(clickType.rawValue, 2)
    }

    func testMouseClickTypeMiddle() {
        let clickType = Exactmac_V1_MouseClick.ClickType.middle
    ...
    func testPointTypeConstruction() {
        let point = Exactmac_Type_Point.with {
            $0.x = 123.45
            $0.y = 678.90
        }
    ...
    func testMouseClickHasPositionFalse() {
        let click = Exactmac_V1_MouseClick()
    ...
    func testMouseMoveHasPositionFalse() {
        let move = Exactmac_V1_MouseMove()
