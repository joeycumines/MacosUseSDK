...
final class CaptureMethodsTests: XCTestCase {
    ...
    func testCaptureScreenshotRequestWithCustomValues() {
        var request = Exactmac_V1_CaptureScreenshotRequest()
    ...
    func testCaptureRegionScreenshotRequestDefaultValues() {
        let request = Exactmac_V1_CaptureRegionScreenshotRequest()
    ...
    func testCaptureRegionScreenshotRequestWithRegion() {
        var request = Exactmac_V1_CaptureRegionScreenshotRequest()
        request.region = Exactmac_Type_Region.with {
            $0.x = 100
            $0.y = 200
            $0.width = 300
            $0.height = 400
    ...
    func testCaptureElementScreenshotRequestDefaultValues() {
        let request = Exactmac_V1_CaptureElementScreenshotRequest()
    ...
    func testCaptureElementScreenshotRequestWithValues() {
        var request = Exactmac_V1_CaptureElementScreenshotRequest()
    ...
    func testRegionTypeDefaultValues() {
        let region = Exactmac_Type_Region()
    ...
    func testFormatDefaultsToPngWhenUnspecified() {
        ...
        let format = Exactmac_V1_ImageFormat.unspecified
        let expectedDefault = Exactmac_V1_ImageFormat.png
    ...
    func testElementRegistryElementHasBounds() async throws {
        ...
        // Element WITH bounds
        var elementWithBounds = Exactmac_V1_Element()
    ...
    func testElementRegistryElementWithoutBounds() async throws {
        ...
        var elementNoBounds = Exactmac_V1_Element()
    ...
    func testCaptureRegionScreenshotResponseFields() {
        ...
        response.width = 500
        response.height = 400
        response.region = Exactmac_Type_Region.with {
            $0.x = -100
            $0.y = 200
            $0.width = 500
            $0.height = 400
