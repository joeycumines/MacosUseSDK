...
public struct Google_Type_PostalAddress: Sendable {
...
extension Google_Type_PostalAddress: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}revision\0\u{3}region_code\0\u{3}language_code\0\u{3}postal_code\0\u{3}sorting_code\0\u{3}administrative_area\0\u{1}locality\0\u{1}sublocality\0\u{3}address_lines\0\u{1}recipients\0\u{1}organization\0")
