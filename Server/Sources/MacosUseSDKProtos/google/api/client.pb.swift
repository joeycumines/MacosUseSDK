...
public enum Google_Api_ClientLibraryOrganization: SwiftProtobuf.Enum, Swift.CaseIterable {
    ...
    public static let allCases: [Google_Api_ClientLibraryOrganization] = [
        .unspecified,
        .cloud,
        .ads,
        .photos,
...
public enum Google_Api_ClientLibraryDestination: SwiftProtobuf.Enum, Swift.CaseIterable {
    ...
    // The compiler won't synthesize support with the UNRECOGNIZED case.
    public static let allCases: [Google_Api_ClientLibraryDestination] = [
        .unspecified,
        .github,
        .packageManager,
    ]
...
public struct Google_Api_CommonLanguageSettings: Sendable {
    ...
    public var referenceDocsUri: String = .init()
    ...
    public var hasSelectiveGapicGeneration: Bool { _selectiveGapicGeneration != nil }
    /// Clears the value of `selectiveGapicGeneration`. Subsequent reads from it will return its default value.
    public mutating func clearSelectiveGapicGeneration() { _selectiveGapicGeneration = nil }

    public var unknownFields = SwiftProtobuf.UnknownStorage()

    public init() {}

    fileprivate var _selectiveGapicGeneration: Google_Api_SelectiveGapicGeneration?
}
...
public struct Google_Api_Publishing: Sendable {
    ...
    public var newIssueUri: String = .init()

    /// Link to product home page.  Example:
    /// https://cloud.google.com/asset-inventory/docs/overview
    public var documentationUri: String = .init()

    /// Used as a tracking tag when collecting data about the APIs developer
    /// relations artifacts like docs, packages delivered to package managers,
    /// etc.  Example: "speech".
    public var apiShortName: String = .init()

    /// GitHub label to apply to issues and pull requests opened for this API.
    public var githubLabel: String = .init()
    ...
    /// documentation.
    public var docTagPrefix: String = .init()
    ...
    public var protoReferenceDocumentationUri: String = .init()

    /// Optional link to REST reference documentation.  Example:
    /// https://cloud.google.com/pubsub/lite/docs/reference/rest
    public var restReferenceDocumentationUri: String = .init()
...
public struct Google_Api_JavaSettings: Sendable {
    ...
    public var libraryPackage: String = .init()
    ...
    public var serviceClassNames: [String: String] = [:]
    ...
    public var hasCommon: Bool { _common != nil }
    /// Clears the value of `common`. Subsequent reads from it will return its default value.
    public mutating func clearCommon() { _common = nil }

    public var unknownFields = SwiftProtobuf.UnknownStorage()

    public init() {}

    fileprivate var _common: Google_Api_CommonLanguageSettings?
}
...
public struct Google_Api_PythonSettings: Sendable {
    ...
    public var hasExperimentalFeatures: Bool { _experimentalFeatures != nil }
    /// Clears the value of `experimentalFeatures`. Subsequent reads from it will return its default value.
    public mutating func clearExperimentalFeatures() { _experimentalFeatures = nil }
    ...
    fileprivate var _common: Google_Api_CommonLanguageSettings?
    fileprivate var _experimentalFeatures: Google_Api_PythonSettings.ExperimentalFeatures?
}
...
public struct Google_Api_DotnetSettings: Sendable {
    ...
    public var renamedServices: [String: String] = [:]
    ...
    public var renamedResources: [String: String] = [:]
...
public struct Google_Api_MethodSettings: Sendable {
    ...
    public var hasLongRunning: Bool { _longRunning != nil }
    /// Clears the value of `longRunning`. Subsequent reads from it will return its default value.
    public mutating func clearLongRunning() { _longRunning = nil }
    ...
    public struct LongRunning: Sendable {
        ...
        public var hasInitialPollDelay: Bool { _initialPollDelay != nil }
        /// Clears the value of `initialPollDelay`. Subsequent reads from it will return its default value.
        public mutating func clearInitialPollDelay() { _initialPollDelay = nil }
        ...
        public var hasMaxPollDelay: Bool { _maxPollDelay != nil }
        /// Clears the value of `maxPollDelay`. Subsequent reads from it will return its default value.
        public mutating func clearMaxPollDelay() { _maxPollDelay = nil }
        ...
        public var hasTotalPollTimeout: Bool { _totalPollTimeout != nil }
        /// Clears the value of `totalPollTimeout`. Subsequent reads from it will return its default value.
        public mutating func clearTotalPollTimeout() { _totalPollTimeout = nil }

        public var unknownFields = SwiftProtobuf.UnknownStorage()

        public init() {}

        fileprivate var _initialPollDelay: SwiftProtobuf.Google_Protobuf_Duration?
        fileprivate var _maxPollDelay: SwiftProtobuf.Google_Protobuf_Duration?
        fileprivate var _totalPollTimeout: SwiftProtobuf.Google_Protobuf_Duration?
    }

    public init() {}

    fileprivate var _longRunning: Google_Api_MethodSettings.LongRunning?
}
...
public extension SwiftProtobuf.Google_Protobuf_MethodOptions {
    ...
    var Google_Api_methodSignature: [String] {
        get { getExtensionValue(ext: Google_Api_Extensions_method_signature) ?? [] }
        set { setExtensionValue(ext: Google_Api_Extensions_method_signature, value: newValue) }
    }
}

public extension SwiftProtobuf.Google_Protobuf_ServiceOptions {
    ...
    var Google_Api_defaultHost: String {
        get { getExtensionValue(ext: Google_Api_Extensions_default_host) ?? String() }
    ...
    var hasGoogle_Api_defaultHost: Bool {
        hasExtensionValue(ext: Google_Api_Extensions_default_host)
    }
    ...
    var Google_Api_oauthScopes: String {
        get { getExtensionValue(ext: Google_Api_Extensions_oauth_scopes) ?? String() }
    ...
    var hasGoogle_Api_oauthScopes: Bool {
        hasExtensionValue(ext: Google_Api_Extensions_oauth_scopes)
    }
    ...
    var Google_Api_apiVersion: String {
        get { getExtensionValue(ext: Google_Api_Extensions_api_version) ?? String() }
    ...
    var hasGoogle_Api_apiVersion: Bool {
        hasExtensionValue(ext: Google_Api_Extensions_api_version)
    }
...
public let Google_Api_Extensions_api_version = SwiftProtobuf.MessageExtension<SwiftProtobuf.OptionalExtensionField<SwiftProtobuf.ProtobufString>, SwiftProtobuf.Google_Protobuf_ServiceOptions>(
    _protobuf_fieldNumber: 525_000_001,
...
extension Google_Api_CommonLanguageSettings: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
    ...
    public mutating func decodeMessage(decoder: inout some SwiftProtobuf.Decoder) throws {
        while let fieldNumber = try decoder.nextFieldNumber() {
            ...
            switch fieldNumber {
            case 1: try decoder.decodeSingularStringField(value: &referenceDocsUri)
            case 2: try decoder.decodeRepeatedEnumField(value: &destinations)
            case 3: try decoder.decodeSingularMessageField(value: &_selectiveGapicGeneration)
            default: break
            }
        }
    }
    ...
    public func traverse(visitor: inout some SwiftProtobuf.Visitor) throws {
        ...
        if !referenceDocsUri.isEmpty {
            try visitor.visitSingularStringField(value: referenceDocsUri, fieldNumber: 1)
        }
        if !destinations.isEmpty {
            try visitor.visitPackedEnumField(value: destinations, fieldNumber: 2)
        }
...
extension Google_Api_ClientLibrarySettings: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
    ...
    fileprivate class _StorageClass {
        ...
        var _javaSettings: Google_Api_JavaSettings?
        var _cppSettings: Google_Api_CppSettings?
        var _phpSettings: Google_Api_PhpSettings?
        var _pythonSettings: Google_Api_PythonSettings?
        var _nodeSettings: Google_Api_NodeSettings?
        var _dotnetSettings: Google_Api_DotnetSettings?
        var _rubySettings: Google_Api_RubySettings?
        var _goSettings: Google_Api_GoSettings?
    ...
    public mutating func decodeMessage(decoder: inout some SwiftProtobuf.Decoder) throws {
        ...
        try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
            while let fieldNumber = try decoder.nextFieldNumber() {
                ...
                case 2: try decoder.decodeSingularEnumField(value: &_storage._launchStage)
                case 3: try decoder.decodeSingularBoolField(value: &_storage._restNumericEnums)
                case 21: try decoder.decodeSingularMessageField(value: &_storage._javaSettings)
                case 22: try decoder.decodeSingularMessageField(value: &_storage._cppSettings)
                case 23: try decoder.decodeSingularMessageField(value: &_storage._phpSettings)
                case 24: try decoder.decodeSingularMessageField(value: &_storage._pythonSettings)
                case 25: try decoder.decodeSingularMessageField(value: &_storage._nodeSettings)
                case 26: try decoder.decodeSingularMessageField(value: &_storage._dotnetSettings)
                case 27: try decoder.decodeSingularMessageField(value: &_storage._rubySettings)
                case 28: try decoder.decodeSingularMessageField(value: &_storage._goSettings)
                default: break
                }
            }
        }
...
extension Google_Api_Publishing: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
    ...
    public mutating func decodeMessage(decoder: inout some SwiftProtobuf.Decoder) throws {
        while let fieldNumber = try decoder.nextFieldNumber() {
            ...
            // enabled. https://github.com/apple/swift-protobuf/issues/1034
            switch fieldNumber {
            case 2: try decoder.decodeRepeatedMessageField(value: &methodSettings)
            case 101: try decoder.decodeSingularStringField(value: &newIssueUri)
            case 102: try decoder.decodeSingularStringField(value: &documentationUri)
            case 103: try decoder.decodeSingularStringField(value: &apiShortName)
            case 104: try decoder.decodeSingularStringField(value: &githubLabel)
            case 105: try decoder.decodeRepeatedStringField(value: &codeownerGithubTeams)
            case 106: try decoder.decodeSingularStringField(value: &docTagPrefix)
            case 107: try decoder.decodeSingularEnumField(value: &organization)
            case 109: try decoder.decodeRepeatedMessageField(value: &librarySettings)
            case 110: try decoder.decodeSingularStringField(value: &protoReferenceDocumentationUri)
            case 111: try decoder.decodeSingularStringField(value: &restReferenceDocumentationUri)
            default: break
            }
        }
    }
    ...
    public func traverse(visitor: inout some SwiftProtobuf.Visitor) throws {
        if !methodSettings.isEmpty {
            try visitor.visitRepeatedMessageField(value: methodSettings, fieldNumber: 2)
        }
        if !newIssueUri.isEmpty {
            try visitor.visitSingularStringField(value: newIssueUri, fieldNumber: 101)
        }
        if !documentationUri.isEmpty {
            try visitor.visitSingularStringField(value: documentationUri, fieldNumber: 102)
        }
        if !apiShortName.isEmpty {
            try visitor.visitSingularStringField(value: apiShortName, fieldNumber: 103)
        }
        if !githubLabel.isEmpty {
            try visitor.visitSingularStringField(value: githubLabel, fieldNumber: 104)
        }
        if !codeownerGithubTeams.isEmpty {
            try visitor.visitRepeatedStringField(value: codeownerGithubTeams, fieldNumber: 105)
        }
        if !docTagPrefix.isEmpty {
            try visitor.visitSingularStringField(value: docTagPrefix, fieldNumber: 106)
        }
        if organization != .unspecified {
            try visitor.visitSingularEnumField(value: organization, fieldNumber: 107)
        }
        if !librarySettings.isEmpty {
            try visitor.visitRepeatedMessageField(value: librarySettings, fieldNumber: 109)
        }
        if !protoReferenceDocumentationUri.isEmpty {
            try visitor.visitSingularStringField(value: protoReferenceDocumentationUri, fieldNumber: 110)
        }
        if !restReferenceDocumentationUri.isEmpty {
            try visitor.visitSingularStringField(value: restReferenceDocumentationUri, fieldNumber: 111)
        }
        try unknownFields.traverse(visitor: &visitor)
    }
...
extension Google_Api_JavaSettings: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
    ...
    public mutating func decodeMessage(decoder: inout some SwiftProtobuf.Decoder) throws {
        while let fieldNumber = try decoder.nextFieldNumber() {
            ...
            // enabled. https://github.com/apple/swift-protobuf/issues/1034
            switch fieldNumber {
            case 1: try decoder.decodeSingularStringField(value: &libraryPackage)
            case 2: try decoder.decodeMapField(fieldType: SwiftProtobuf._ProtobufMap<SwiftProtobuf.ProtobufString, SwiftProtobuf.ProtobufString>.self, value: &serviceClassNames)
            case 3: try decoder.decodeSingularMessageField(value: &_common)
            default: break
            }
        }
    }
    ...
    public func traverse(visitor: inout some SwiftProtobuf.Visitor) throws {
        ...
        // are enabled. https://github.com/apple/swift-protobuf/issues/1034 and
        // https://github.com/apple/swift-protobuf/issues/1182
        if !libraryPackage.isEmpty {
            try visitor.visitSingularStringField(value: libraryPackage, fieldNumber: 1)
        }
        if !serviceClassNames.isEmpty {
            try visitor.visitMapField(fieldType: SwiftProtobuf._ProtobufMap<SwiftProtobuf.ProtobufString, SwiftProtobuf.ProtobufString>.self, value: serviceClassNames, fieldNumber: 2)
        }
...
extension Google_Api_PythonSettings: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
    ...
    public mutating func decodeMessage(decoder: inout some SwiftProtobuf.Decoder) throws {
        while let fieldNumber = try decoder.nextFieldNumber() {
            ...
            switch fieldNumber {
            case 1: try decoder.decodeSingularMessageField(value: &_common)
            case 2: try decoder.decodeSingularMessageField(value: &_experimentalFeatures)
            default: break
            }
        }
    }
...
extension Google_Api_PythonSettings.ExperimentalFeatures: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
    ...
    public mutating func decodeMessage(decoder: inout some SwiftProtobuf.Decoder) throws {
        while let fieldNumber = try decoder.nextFieldNumber() {
            ...
            // enabled. https://github.com/apple/swift-protobuf/issues/1034
            switch fieldNumber {
            case 1: try decoder.decodeSingularBoolField(value: &restAsyncIoEnabled)
            case 2: try decoder.decodeSingularBoolField(value: &protobufPythonicTypesEnabled)
            case 3: try decoder.decodeSingularBoolField(value: &unversionedPackageDisabled)
            default: break
            }
        }
    }
    ...
    public func traverse(visitor: inout some SwiftProtobuf.Visitor) throws {
        if restAsyncIoEnabled != false {
            try visitor.visitSingularBoolField(value: restAsyncIoEnabled, fieldNumber: 1)
        }
        if protobufPythonicTypesEnabled != false {
            try visitor.visitSingularBoolField(value: protobufPythonicTypesEnabled, fieldNumber: 2)
        }
        if unversionedPackageDisabled != false {
            try visitor.visitSingularBoolField(value: unversionedPackageDisabled, fieldNumber: 3)
        }
        try unknownFields.traverse(visitor: &visitor)
    }
...
extension Google_Api_DotnetSettings: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
    ...
    public mutating func decodeMessage(decoder: inout some SwiftProtobuf.Decoder) throws {
        while let fieldNumber = try decoder.nextFieldNumber() {
            ...
            switch fieldNumber {
            case 1: try decoder.decodeSingularMessageField(value: &_common)
            case 2: try decoder.decodeMapField(fieldType: SwiftProtobuf._ProtobufMap<SwiftProtobuf.ProtobufString, SwiftProtobuf.ProtobufString>.self, value: &renamedServices)
            case 3: try decoder.decodeMapField(fieldType: SwiftProtobuf._ProtobufMap<SwiftProtobuf.ProtobufString, SwiftProtobuf.ProtobufString>.self, value: &renamedResources)
            case 4: try decoder.decodeRepeatedStringField(value: &ignoredResources)
            case 5: try decoder.decodeRepeatedStringField(value: &forcedNamespaceAliases)
            case 6: try decoder.decodeRepeatedStringField(value: &handwrittenSignatures)
            default: break
            }
        }
    }
    ...
    public func traverse(visitor: inout some SwiftProtobuf.Visitor) throws {
        ...
        if !renamedServices.isEmpty {
            try visitor.visitMapField(fieldType: SwiftProtobuf._ProtobufMap<SwiftProtobuf.ProtobufString, SwiftProtobuf.ProtobufString>.self, value: renamedServices, fieldNumber: 2)
        }
        if !renamedResources.isEmpty {
            try visitor.visitMapField(fieldType: SwiftProtobuf._ProtobufMap<SwiftProtobuf.ProtobufString, SwiftProtobuf.ProtobufString>.self, value: renamedResources, fieldNumber: 3)
        }
        if !ignoredResources.isEmpty {
            try visitor.visitRepeatedStringField(value: ignoredResources, fieldNumber: 4)
        }
        if !forcedNamespaceAliases.isEmpty {
            try visitor.visitRepeatedStringField(value: forcedNamespaceAliases, fieldNumber: 5)
        }
        if !handwrittenSignatures.isEmpty {
            try visitor.visitRepeatedStringField(value: handwrittenSignatures, fieldNumber: 6)
        }
        try unknownFields.traverse(visitor: &visitor)
    }
...
extension Google_Api_MethodSettings: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
    ...
    public mutating func decodeMessage(decoder: inout some SwiftProtobuf.Decoder) throws {
        while let fieldNumber = try decoder.nextFieldNumber() {
            ...
            case 2: try decoder.decodeSingularMessageField(value: &_longRunning)
            case 3: try decoder.decodeRepeatedStringField(value: &autoPopulatedFields)
            default: break
            }
        }
    }
    ...
    public func traverse(visitor: inout some SwiftProtobuf.Visitor) throws {
        ...
        if !autoPopulatedFields.isEmpty {
            try visitor.visitRepeatedStringField(value: autoPopulatedFields, fieldNumber: 3)
        }
        try unknownFields.traverse(visitor: &visitor)
    }
...
extension Google_Api_MethodSettings.LongRunning: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
    ...
    public mutating func decodeMessage(decoder: inout some SwiftProtobuf.Decoder) throws {
        while let fieldNumber = try decoder.nextFieldNumber() {
            ...
            // enabled. https://github.com/apple/swift-protobuf/issues/1034
            switch fieldNumber {
            case 1: try decoder.decodeSingularMessageField(value: &_initialPollDelay)
            case 2: try decoder.decodeSingularFloatField(value: &pollDelayMultiplier)
            case 3: try decoder.decodeSingularMessageField(value: &_maxPollDelay)
            case 4: try decoder.decodeSingularMessageField(value: &_totalPollTimeout)
            default: break
            }
        }
    }
    ...
    public func traverse(visitor: inout some SwiftProtobuf.Visitor) throws {
        ...
        // are enabled. https://github.com/apple/swift-protobuf/issues/1034 and
        // https://github.com/apple/swift-protobuf/issues/1182
        if let v = _initialPollDelay {
            try visitor.visitSingularMessageField(value: v, fieldNumber: 1)
        }
        if pollDelayMultiplier.bitPattern != 0 {
            try visitor.visitSingularFloatField(value: pollDelayMultiplier, fieldNumber: 2)
        }
...
extension Google_Api_SelectiveGapicGeneration: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
    ...
    public mutating func decodeMessage(decoder: inout some SwiftProtobuf.Decoder) throws {
        while let fieldNumber = try decoder.nextFieldNumber() {
            ...
            // enabled. https://github.com/apple/swift-protobuf/issues/1034
            switch fieldNumber {
            case 1: try decoder.decodeRepeatedStringField(value: &methods)
            case 2: try decoder.decodeSingularBoolField(value: &generateOmittedAsInternal)
            default: break
            }
        }
    }
    ...
    public func traverse(visitor: inout some SwiftProtobuf.Visitor) throws {
        if !methods.isEmpty {
            try visitor.visitRepeatedStringField(value: methods, fieldNumber: 1)
        }
        if generateOmittedAsInternal != false {
            try visitor.visitSingularBoolField(value: generateOmittedAsInternal, fieldNumber: 2)
        }
        try unknownFields.traverse(visitor: &visitor)
    }
