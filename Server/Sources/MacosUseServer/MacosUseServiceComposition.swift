...
struct MacosUseServiceComposition {
    ...
    init(
        ...
        let inputTransactionExecutor = macosUseService.inputTransactionExecutor
        let macroExecutor = macosUseService.macroExecutor
        let serviceLifetime = ServiceLifetime(
            stateStore: stateStore,
            operationStore: operationStore,
            observationManager: observationManager,
        ...
        self.macosUseService = macosUseService
