...
/// Rejects preserved protobuf intent before any public MacosUse or Operations
...
struct PublicRequestDescriptorPolicy: Sendable {
    ...
    static let optionalOneofs: Set<String> = [
        "macosusesdk.type.ElementSelector.criteria",
    ]
    ...
    static func load() throws -> Self {
        ...
        guard let descriptorURL = descriptorURLs.first(where: {
            $0.lastPathComponent == "macosuse_descriptors.pb"
        }) else {
