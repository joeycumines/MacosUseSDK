...
final class OperationsProvider: Google_Longrunning_OperationsAsyncProvider {
  ...
  func listOperations(
    request: Google_Longrunning_ListOperationsRequest, context: GRPCAsyncServerCallContext
  ...
  func getOperation(
    request: Google_Longrunning_GetOperationRequest, context: GRPCAsyncServerCallContext
  ...
  func deleteOperation(
    request: Google_Longrunning_DeleteOperationRequest, context: GRPCAsyncServerCallContext
  ...
  func cancelOperation(
    request: Google_Longrunning_CancelOperationRequest, context: GRPCAsyncServerCallContext
  ) async throws -> SwiftProtobuf.Google_Protobuf_Empty {
  ...
  func waitOperation(
    request: Google_Longrunning_WaitOperationRequest, context: GRPCAsyncServerCallContext
  ) async throws -> Google_Longrunning_Operation {
