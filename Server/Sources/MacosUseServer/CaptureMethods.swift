...
extension MacosUseService {
    func captureScreenshot(
        request: ServerRequest<Macosusesdk_V1_CaptureScreenshotRequest>, context: ServerContext,
    ...
    func captureElementScreenshot(
        request: ServerRequest<Macosusesdk_V1_CaptureElementScreenshotRequest>, context: ServerContext,
    ...
    func captureRegionScreenshot(
        request: ServerRequest<Macosusesdk_V1_CaptureRegionScreenshotRequest>, context: ServerContext,
    ...
    private func applyOCRResult(
        ...
        to response: inout Macosusesdk_V1_CaptureScreenshotResponse,
    ) {
        switch result {
        case .notRequested:
            break
    ...
    private func applyOCRResult(
        _ result: ScreenshotOCRResult,
        to response: inout Macosusesdk_V1_CaptureRegionScreenshotResponse,
    ) {
        switch result {
        case .notRequested:
            break
    ...
    private func applyOCRResult(
        _ result: ScreenshotOCRResult,
        to response: inout Macosusesdk_V1_CaptureElementScreenshotResponse,
    ) {
        switch result {
        case .notRequested:
            break
