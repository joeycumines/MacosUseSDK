...
public actor OperationStore {
    ...
    public func createOperation(name: String, metadata: SwiftProtobuf.Google_Protobuf_Any? = nil) -> Google_Longrunning_Operation {
    ...
    public func finishOperation(name: String, responseMessage: SwiftProtobuf.Message) throws {
        guard var op = operations[name] else {
            throw NSError(domain: "OperationStore", code: 1, userInfo: [NSLocalizedDescriptionKey: "operation not found"])
        }
