...
struct PreparedInputAction: Sendable {
    ...
    let showAnimation: Bool
    let animationDuration: Double
    let keyboardSourceIdentity: MacosUseSDK.KeyboardInputSourceIdentity?
    ...
    init(
        ...
        keyboardSourceIdentity: MacosUseSDK.KeyboardInputSourceIdentity? = nil,
...
enum InputActionAdmission {
    static func validate(
        protoAction: Macosusesdk_V1_InputAction,
        sdkAction: MacosUseSDK.InputAction,
