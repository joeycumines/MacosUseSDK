...
public nonisolated struct Exactmac_Type_Point: Sendable {
...
public nonisolated struct Exactmac_Type_Region: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
nonisolated extension Exactmac_Type_Point: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Exactmac_Type_Point, rhs: Exactmac_Type_Point) -> Bool {
...
nonisolated extension Exactmac_Type_Region: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Exactmac_Type_Region, rhs: Exactmac_Type_Region) -> Bool {
    if lhs.x != rhs.x {return false}
    if lhs.y != rhs.y {return false}
