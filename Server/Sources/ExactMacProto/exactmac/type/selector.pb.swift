...
public nonisolated struct Exactmac_Type_ElementSelector: Sendable {
  ...
  public var criteria: Exactmac_Type_ElementSelector.OneOf_Criteria? = nil
  ...
  public var position: Exactmac_Type_PositionSelector {
    get {
      if case .position(let v)? = criteria {return v}
      return Exactmac_Type_PositionSelector()
    }
    set {criteria = .position(newValue)}
  }

  /// Select by attributes.
  public var attributes: Exactmac_Type_AttributeSelector {
    get {
      if case .attributes(let v)? = criteria {return v}
      return Exactmac_Type_AttributeSelector()
    }
    set {criteria = .attributes(newValue)}
  }

  /// Compound selector (combine multiple criteria).
  public var compound: Exactmac_Type_CompoundSelector {
    get {
      if case .compound(let v)? = criteria {return v}
      return Exactmac_Type_CompoundSelector()
    }
  ...
  public nonisolated enum OneOf_Criteria: Equatable, Sendable {
    ...
    /// Select by position on screen.
    case position(Exactmac_Type_PositionSelector)
    /// Select by attributes.
    case attributes(Exactmac_Type_AttributeSelector)
    /// Compound selector (combine multiple criteria).
    case compound(Exactmac_Type_CompoundSelector)
...
public nonisolated struct Exactmac_Type_PositionSelector: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public nonisolated struct Exactmac_Type_AttributeSelector: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public nonisolated struct Exactmac_Type_CompoundSelector: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public nonisolated enum Operator: SwiftProtobuf.Enum, Swift.CaseIterable {
    ...
    public static let allCases: [Exactmac_Type_CompoundSelector.Operator] = [
      .unspecified,
      .and,
      .or,
      .not,
...
nonisolated extension Exactmac_Type_ElementSelector: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 5: try {
        var v: Exactmac_Type_PositionSelector?
      ...
      case 6: try {
        var v: Exactmac_Type_AttributeSelector?
        var hadOneofValue = false
        if let current = self.criteria {
          hadOneofValue = true
      ...
      case 7: try {
        var v: Exactmac_Type_CompoundSelector?
        var hadOneofValue = false
        if let current = self.criteria {
          hadOneofValue = true
  ...
  public static func ==(lhs: Exactmac_Type_ElementSelector, rhs: Exactmac_Type_ElementSelector) -> Bool {
...
nonisolated extension Exactmac_Type_PositionSelector: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Exactmac_Type_PositionSelector, rhs: Exactmac_Type_PositionSelector) -> Bool {
...
nonisolated extension Exactmac_Type_AttributeSelector: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Exactmac_Type_AttributeSelector, rhs: Exactmac_Type_AttributeSelector) -> Bool {
...
nonisolated extension Exactmac_Type_CompoundSelector.Operator: SwiftProtobuf._ProtoNameProviding {
