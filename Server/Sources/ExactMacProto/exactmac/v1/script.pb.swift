...
public nonisolated enum Exactmac_V1_ScriptType: SwiftProtobuf.Enum, Swift.CaseIterable {
  ...
  public static let allCases: [Exactmac_V1_ScriptType] = [
    .unspecified,
    .applescript,
    .jxa,
    .shell,
...
public nonisolated struct Exactmac_V1_ScriptingDictionary: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
nonisolated extension Exactmac_V1_ScriptType: SwiftProtobuf._ProtoNameProviding {
...
nonisolated extension Exactmac_V1_ScriptingDictionary: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Exactmac_V1_ScriptingDictionary, rhs: Exactmac_V1_ScriptingDictionary) -> Bool {
