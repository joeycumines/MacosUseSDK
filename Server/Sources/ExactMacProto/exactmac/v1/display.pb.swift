...
public nonisolated struct Exactmac_V1_Display: Sendable {
  ...
  public var frame: Exactmac_Type_Region {
    get {_frame ?? Exactmac_Type_Region()}
    set {_frame = newValue}
  }
  ...
  /// See exactmac.type.Point message documentation for detailed coordinate system explanation.
  public var visibleFrame: Exactmac_Type_Region {
    get {_visibleFrame ?? Exactmac_Type_Region()}
  ...
  fileprivate var _frame: Exactmac_Type_Region? = nil
  fileprivate var _visibleFrame: Exactmac_Type_Region? = nil
}

/// Request to list displays.
public nonisolated struct Exactmac_V1_ListDisplaysRequest: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public nonisolated struct Exactmac_V1_GetDisplayRequest: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public nonisolated struct Exactmac_V1_ListDisplaysResponse: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  /// The displays in arbitrary order. For stable ordering use the display_id.
  public var displays: [Exactmac_V1_Display] = []
...
public nonisolated struct Exactmac_V1_CaptureCursorPositionRequest: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public nonisolated struct Exactmac_V1_CaptureCursorPositionResponse: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
nonisolated extension Exactmac_V1_Display: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Exactmac_V1_Display, rhs: Exactmac_V1_Display) -> Bool {
...
nonisolated extension Exactmac_V1_GetDisplayRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Exactmac_V1_GetDisplayRequest, rhs: Exactmac_V1_GetDisplayRequest) -> Bool {
    if lhs.name != rhs.name {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
...
nonisolated extension Exactmac_V1_ListDisplaysResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Exactmac_V1_ListDisplaysResponse, rhs: Exactmac_V1_ListDisplaysResponse) -> Bool {
...
nonisolated extension Exactmac_V1_CaptureCursorPositionRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Exactmac_V1_CaptureCursorPositionRequest, rhs: Exactmac_V1_CaptureCursorPositionRequest) -> Bool {
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}

nonisolated extension Exactmac_V1_CaptureCursorPositionResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Exactmac_V1_CaptureCursorPositionResponse, rhs: Exactmac_V1_CaptureCursorPositionResponse) -> Bool {
