...
public nonisolated enum Exactmac_V1_ApplicationView: SwiftProtobuf.Enum, Swift.CaseIterable {
  ...
  public static let allCases: [Exactmac_V1_ApplicationView] = [
    .unspecified,
    .basic,
    .full,
  ]
...
/// bundle identifier.
public nonisolated struct Exactmac_V1_ApplicationBundle: Sendable {
...
public nonisolated struct Exactmac_V1_Application: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
nonisolated extension Exactmac_V1_ApplicationView: SwiftProtobuf._ProtoNameProviding {
...
nonisolated extension Exactmac_V1_ApplicationBundle: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Exactmac_V1_ApplicationBundle, rhs: Exactmac_V1_ApplicationBundle) -> Bool {
...
nonisolated extension Exactmac_V1_Application: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Exactmac_V1_Application, rhs: Exactmac_V1_Application) -> Bool {
    if lhs.name != rhs.name {return false}
