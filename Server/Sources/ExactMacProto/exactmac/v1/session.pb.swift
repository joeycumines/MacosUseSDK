...
public nonisolated struct Exactmac_V1_Session: Sendable {
  ...
  public var state: Exactmac_V1_Session.State = .unspecified
  ...
  public nonisolated enum State: SwiftProtobuf.Enum, Swift.CaseIterable {
    ...
    public static let allCases: [Exactmac_V1_Session.State] = [
      .unspecified,
      .active,
      .inTransaction,
      .terminated,
...
public nonisolated struct Exactmac_V1_Transaction: @unchecked Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  /// Transaction state.
  public var state: Exactmac_V1_Transaction.State {
    get {_storage._state}
  ...
  public var updatedSession: Exactmac_V1_Session {
    get {_storage._updatedSession ?? Exactmac_V1_Session()}
  ...
  public nonisolated enum State: SwiftProtobuf.Enum, Swift.CaseIterable {
    ...
    // The compiler won't synthesize support with the UNRECOGNIZED case.
    public static let allCases: [Exactmac_V1_Transaction.State] = [
      .unspecified,
      .active,
      .committed,
      .rolledBack,
...
public nonisolated struct Exactmac_V1_SessionSnapshot: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public nonisolated struct Exactmac_V1_OperationRecord: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
nonisolated extension Exactmac_V1_Session: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Exactmac_V1_Session, rhs: Exactmac_V1_Session) -> Bool {
...
nonisolated extension Exactmac_V1_Session.State: SwiftProtobuf._ProtoNameProviding {
...
nonisolated extension Exactmac_V1_Transaction: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  fileprivate class _StorageClass {
    ...
    var _state: Exactmac_V1_Transaction.State = .unspecified
    var _startTime: SwiftProtobuf.Google_Protobuf_Timestamp? = nil
    var _operationsCount: Int32 = 0
    var _updatedSession: Exactmac_V1_Session? = nil
  ...
  public static func ==(lhs: Exactmac_V1_Transaction, rhs: Exactmac_V1_Transaction) -> Bool {
...
nonisolated extension Exactmac_V1_Transaction.State: SwiftProtobuf._ProtoNameProviding {
...
nonisolated extension Exactmac_V1_SessionSnapshot: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Exactmac_V1_SessionSnapshot, rhs: Exactmac_V1_SessionSnapshot) -> Bool {
...
nonisolated extension Exactmac_V1_OperationRecord: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Exactmac_V1_OperationRecord, rhs: Exactmac_V1_OperationRecord) -> Bool {
