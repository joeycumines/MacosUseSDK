...
private let logger = ExactMac.sdkLogger(category: "SelectorParser")
...
public struct SelectorParser {
    ...
    public func parseSelector(_ selector: Exactmac_Type_ElementSelector) throws
        -> Exactmac_Type_ElementSelector
    {
    ...
    private func validateSelector(_ selector: Exactmac_Type_ElementSelector) throws {
    ...
    public func describeSelector(_ selector: Exactmac_Type_ElementSelector) -> String {
        switch selector.criteria {
        case let .role(role):
            return "role='\(role)'"
        case let .text(text):
