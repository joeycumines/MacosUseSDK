...
private let logger = ExactMac.sdkLogger(category: "MacroExecutor")
...
public actor MacroExecutor {
    ...
    private func executeAction(
        _ action: Exactmac_V1_MacroAction,
    ...
    private func executeInputAction(
        _ inputAction: Exactmac_V1_InputAction,
        context: inout MacroContext,
    ) async throws {
    ...
    private func executeWaitAction(
        _ waitAction: Exactmac_V1_WaitAction,
    ...
    private func evaluateWaitCondition(
        _ condition: Exactmac_V1_WaitCondition,
        context: MacroContext,
    ) async throws -> Bool {
    ...
    private func executeConditionalAction(
        _ conditionalAction: Exactmac_V1_ConditionalAction,
        context: inout MacroContext,
        control: MacroExecutionControl,
    ) async throws {
    ...
    private func evaluateCondition(
        _ condition: Exactmac_V1_MacroCondition,
        context: MacroContext,
        control: MacroExecutionControl,
    ) async throws -> Bool {
    ...
    private func evaluateCompoundCondition(
        _ compound: Exactmac_V1_CompoundCondition,
        context: MacroContext,
        control: MacroExecutionControl,
    ) async throws -> Bool {
    ...
    private func executeLoopAction(
        _ loopAction: Exactmac_V1_LoopAction,
        context: inout MacroContext,
        control: MacroExecutionControl,
    ) async throws {
    ...
    private func executeForEachLoop(
        _ forEach: Exactmac_V1_ForEachLoop,
    ...
    private func executeAssignAction(
        _ assignAction: Exactmac_V1_AssignAction,
        context: inout MacroContext,
    ) throws {
        let value: String
    ...
    private func executeMethodCall(
        _ methodCall: Exactmac_V1_MethodCall,
        context: inout MacroContext,
    ) async throws {
    ...
    private func executePhysicalInput(
        _ action: Exactmac_V1_InputAction,
        ordinal: UInt64,
        context: MacroContext,
    ) async throws {
    ...
    private func substituteVariables(
        in action: Exactmac_V1_InputAction,
        context: MacroContext,
