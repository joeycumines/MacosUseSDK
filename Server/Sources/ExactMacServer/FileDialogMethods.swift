...
extension ExactMacService {
    func automateOpenFileDialog(
        request: ServerRequest<Exactmac_V1_AutomateOpenFileDialogRequest>, context _: ServerContext,
    ) async throws -> ServerResponse<Exactmac_V1_AutomateOpenFileDialogResponse> {
    ...
    func automateSaveFileDialog(
        request: ServerRequest<Exactmac_V1_AutomateSaveFileDialogRequest>, context _: ServerContext,
    ) async throws -> ServerResponse<Exactmac_V1_AutomateSaveFileDialogResponse> {
        let req = request.message
...
private extension ExactMacService {
