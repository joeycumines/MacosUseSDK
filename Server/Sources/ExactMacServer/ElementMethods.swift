...
extension ExactMacService {
    func traverseAccessibility(
        request: ServerRequest<Exactmac_V1_TraverseAccessibilityRequest>, context _: ServerContext,
    ) async throws -> ServerResponse<Exactmac_V1_TraverseAccessibilityResponse> {
    ...
    func watchAccessibility(
        request: ServerRequest<Exactmac_V1_WatchAccessibilityRequest>,
        context _: ServerContext,
    ) async throws -> StreamingServerResponse<Exactmac_V1_WatchAccessibilityResponse> {
        let req = request.message
        ...
        return StreamingServerResponse { [automationCoordinator] writer in
            let ownedStream = try await automationCoordinator.createTraversalStreamTask {
                var previousByPath: [String: Exactmac_V1_Element] = [:]
                ...
                while true {
                    ...
                    var currentByPath: [String: Exactmac_V1_Element] = [:]
                    ...
                    // Compute diff
                    var added: [Exactmac_V1_Element] = []
                    var removed: [Exactmac_V1_Element] = []
                    var modified: [Exactmac_V1_ModifiedElement] = []
                    ...
                    for (pathKey, currentElement) in currentByPath {
                        if let previousElement = previousByPath[pathKey] {
                            ...
                            if !changes.isEmpty {
                                modified.append(Exactmac_V1_ModifiedElement.with {
    ...
    func computeElementChanges(
        old: Exactmac_V1_Element,
        new: Exactmac_V1_Element,
    ) -> [Exactmac_V1_AttributeChange] {
        var changes: [Exactmac_V1_AttributeChange] = []

        // Compare role
        if old.role != new.role {
            changes.append(Exactmac_V1_AttributeChange.with {
                $0.attribute = "role"
                $0.oldValue = old.role
                $0.newValue = new.role
            })
    ...
    func findElements(
        ...
        let response = Exactmac_V1_FindElementsResponse.with {
            $0.elements = elements
    ...
    func findRegionElements(
        ...
        let response = Exactmac_V1_FindRegionElementsResponse.with {
            $0.elements = elements
            $0.nextPageToken = nextPageToken
        }
        return ServerResponse(message: response)
    ...
    func getElement(
        request: ServerRequest<Exactmac_V1_GetElementRequest>, context _: ServerContext,
    ) async throws -> ServerResponse<Exactmac_V1_Element> {
        let req = request.message
    ...
    func listElements(
        request: ServerRequest<Exactmac_V1_ListElementsRequest>, context _: ServerContext,
    ) async throws -> ServerResponse<Exactmac_V1_ListElementsResponse> {
        let req = request.message
        ...
        return ServerResponse(message: Exactmac_V1_ListElementsResponse.with {
            $0.elements = page
            $0.nextPageToken = nextPageToken
        })
    }
    ...
    func clickElement(
        request: ServerRequest<Exactmac_V1_ClickElementRequest>, context _: ServerContext,
    ) async throws -> ServerResponse<Exactmac_V1_ClickElementResponse> {
        let req = request.message
        ...
        let response = try await automationCoordinator.handlePhysicalMutationWithOwner { context, ownerID in
            ...
            let action: ExactMac.InputAction = switch req.clickType {
            ...
            return Exactmac_V1_ClickElementResponse.with {
                $0.success = true
                $0.element = element
                $0.input = inputName
            }
    ...
    private static func finalizeWriteElementValue(
        element: inout Exactmac_V1_Element,
        expectedText: String,
    ...
    ) async throws -> Exactmac_V1_WriteElementValueResponse {
        ...
        return Exactmac_V1_WriteElementValueResponse.with {
            $0.success = true
            $0.element = element
    ...
    func writeElementValue(
        request: ServerRequest<Exactmac_V1_WriteElementValueRequest>, context _: ServerContext,
    ) async throws -> ServerResponse<Exactmac_V1_WriteElementValueResponse> {
        let req = request.message
        ...
        let response = try await automationCoordinator.handlePhysicalMutationWithOwner { context, ownerID in
            ...
            case .keystrokeReplacement:
                ...
                if textToType.isEmpty {
                    ...
                    let deleteAction: ExactMac.InputAction = .press(keyName: "delete", flags: [])
                    ...
                    let typeAction: ExactMac.InputAction = .typeText(text: textToType, charDelay: 0.01)
                    committedInputName = try await self.publishElementInputResource(
                        action: typeAction,
                        parent: req.parent,
                        ownerID: ownerID,
    ...
    private static func parseElementMutationTarget(
        _ target: Exactmac_V1_ClickElementRequest.OneOf_Target?,
    ...
    private static func parseElementMutationTarget(
        _ target: Exactmac_V1_WriteElementValueRequest.OneOf_Target?,
    ) throws -> ElementMutationTarget {
        switch target {
        case let .elementID(id):
            return .elementID(id)
    ...
    private static func parseElementMutationTarget(
        _ target: Exactmac_V1_PerformElementActionRequest.OneOf_Target?,
    ) throws -> ElementMutationTarget {
        switch target {
        case let .elementID(id):
            return .elementID(id)
    ...
    func getElementActions(
        request: ServerRequest<Exactmac_V1_GetElementActionsRequest>, context _: ServerContext,
    ) async throws -> ServerResponse<Exactmac_V1_ElementActions> {
        let req = request.message
        ...
        if let axElement = await elementRegistry.getAXElement(
            ...
            if let actionsArray = system.copyAXAttribute(
                ...
                let response = Exactmac_V1_ElementActions.with {
    ...
    func performElementAction(
        request: ServerRequest<Exactmac_V1_PerformElementActionRequest>, context _: ServerContext,
    ) async throws -> ServerResponse<Exactmac_V1_PerformElementActionResponse> {
        let req = request.message
        ...
        let response = try await automationCoordinator.handlePhysicalMutation { context in
            ...
            return Exactmac_V1_PerformElementActionResponse.with {
                $0.success = true
                $0.element = element
            }
        }
    ...
    func waitElement(
        request: ServerRequest<Exactmac_V1_WaitElementRequest>, context _: ServerContext,
        ...
        let metadata = try SwiftProtobuf.Google_Protobuf_Any.with {
            $0.typeURL = "type.googleapis.com/exactmac.v1.WaitElementMetadata"
            $0.value = try Exactmac_V1_WaitElementMetadata.with {
                $0.selector = selector
                $0.attempts = 0
            }.serializedData()
        }
            ...
            execution: { [operationStore, elementLocator] in
                do {
                    ...
                    while Date().timeIntervalSince1970 < endTime {
                        ...
                        let updatedMetadata = Exactmac_V1_WaitElementMetadata.with {
                            $0.selector = selector
    ...
    func waitElementState(
        request: ServerRequest<Exactmac_V1_WaitElementStateRequest>, context _: ServerContext,
    ) async throws -> ServerResponse<Google_Longrunning_Operation> {
        let req = request.message
        ...
        let opName = "operations/\(UUID().uuidString)"
        let metadata = try SwiftProtobuf.Google_Protobuf_Any.with {
            $0.typeURL = "type.googleapis.com/exactmac.v1.WaitElementStateMetadata"
            $0.value = try Exactmac_V1_WaitElementStateMetadata.with {
            ...
            execution: { [operationStore, elementLocator] in
                do {
                    ...
                    while Date().timeIntervalSince1970 < endTime {
                        ...
                        // Update metadata with attempt count
                        let updatedMetadata = Exactmac_V1_WaitElementStateMetadata.with {
                            $0.condition = req.condition
                            $0.attempts = Int32(attempts)
                        }
                        let metadata = try SwiftProtobuf.Google_Protobuf_Any.with {
    ...
    /// - Note: Internal for testing with @testable import.
    static func elementClickPointIsOnScreen(_ element: Exactmac_V1_Element) -> Bool {
    ...
    static func elementClickPoint(_ element: Exactmac_V1_Element) throws -> CGPoint {
