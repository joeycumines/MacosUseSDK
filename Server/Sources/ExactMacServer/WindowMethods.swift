...
extension ExactMacService {
    func getWindow(
        request: ServerRequest<Exactmac_V1_GetWindowRequest>, context: ServerContext,
    ) async throws -> ServerResponse<Exactmac_V1_Window> {
    ...
    func listWindows(
        request: ServerRequest<Exactmac_V1_ListWindowsRequest>, context _: ServerContext,
    ) async throws -> ServerResponse<Exactmac_V1_ListWindowsResponse> {
        let req = request.message
        ...
        let response = Exactmac_V1_ListWindowsResponse.with {
            $0.windows = windows
    ...
    func getWindowState(
        request: ServerRequest<Exactmac_V1_GetWindowStateRequest>, context: ServerContext,
    ) async throws -> ServerResponse<Exactmac_V1_WindowState> {
        let req = request.message
    ...
    func focusWindow(
        request: ServerRequest<Exactmac_V1_FocusWindowRequest>, context: ServerContext,
    ) async throws -> ServerResponse<Exactmac_V1_Window> {
    ...
    private func focusWindowAdmitted(
        request: ServerRequest<Exactmac_V1_FocusWindowRequest>,
    ...
    func moveWindow(
        request: ServerRequest<Exactmac_V1_MoveWindowRequest>, context: ServerContext,
    ) async throws -> ServerResponse<Exactmac_V1_Window> {
        try await withOwnedWindowMutation(cancellation: context.cancellation) {
    ...
    private func moveWindowAdmitted(
        request: ServerRequest<Exactmac_V1_MoveWindowRequest>,
        cancellation: ServerContext.RPCCancellationHandle?,
    ) async throws -> ServerResponse<Exactmac_V1_Window> {
        let req = request.message
    ...
    func resizeWindow(
        request: ServerRequest<Exactmac_V1_ResizeWindowRequest>, context: ServerContext,
    ) async throws -> ServerResponse<Exactmac_V1_Window> {
        try await withOwnedWindowMutation(cancellation: context.cancellation) {
    ...
    private func resizeWindowAdmitted(
        request: ServerRequest<Exactmac_V1_ResizeWindowRequest>,
        cancellation: ServerContext.RPCCancellationHandle?,
    ) async throws -> ServerResponse<Exactmac_V1_Window> {
        let req = request.message
    ...
    func minimizeWindow(
        request: ServerRequest<Exactmac_V1_MinimizeWindowRequest>, context: ServerContext,
    ) async throws -> ServerResponse<Exactmac_V1_Window> {
        try await withOwnedWindowMutation(cancellation: context.cancellation) {
    ...
    private func minimizeWindowAdmitted(
        request: ServerRequest<Exactmac_V1_MinimizeWindowRequest>,
        cancellation: ServerContext.RPCCancellationHandle?,
    ) async throws -> ServerResponse<Exactmac_V1_Window> {
        let req = request.message
    ...
    func restoreWindow(
        request: ServerRequest<Exactmac_V1_RestoreWindowRequest>, context: ServerContext,
    ) async throws -> ServerResponse<Exactmac_V1_Window> {
        try await withOwnedWindowMutation(cancellation: context.cancellation) {
    ...
    private func restoreWindowAdmitted(
        request: ServerRequest<Exactmac_V1_RestoreWindowRequest>,
        cancellation: ServerContext.RPCCancellationHandle?,
    ) async throws -> ServerResponse<Exactmac_V1_Window> {
        let req = request.message
    ...
    func closeWindow(
        request: ServerRequest<Exactmac_V1_CloseWindowRequest>, context: ServerContext,
    ) async throws -> ServerResponse<Exactmac_V1_CloseWindowResponse> {
    ...
    private func closeWindowAdmitted(
        request: ServerRequest<Exactmac_V1_CloseWindowRequest>,
        cancellation: ServerContext.RPCCancellationHandle?,
    ) async throws -> ServerResponse<Exactmac_V1_CloseWindowResponse> {
        let req = request.message
        ...
        return ServerResponse(message: Exactmac_V1_CloseWindowResponse.with { $0.success = true })
    }
    ...
    func captureWindowScreenshot(
        request: ServerRequest<Exactmac_V1_CaptureWindowScreenshotRequest>, context: ServerContext,
    ) async throws -> ServerResponse<Exactmac_V1_CaptureWindowScreenshotResponse> {
        let req = request.message
        ...
        return try await captureWorkOwner.withCapture(cancellation: context.cancellation) { [self] in
            ...
            var response = Exactmac_V1_CaptureWindowScreenshotResponse()
    ...
    private func windowCaptureRegionMessage(_ frame: CGRect) -> Exactmac_Type_Region {
        .with {
            $0.x = frame.origin.x
            $0.y = frame.origin.y
            $0.width = frame.width
