...
struct ActionTool {
    static func main() async {
        ...
        //
        fputs(
            "info: Main logic complete. Pausing to allow async animations to complete before exiting...\n",
            stderr,
        ) // Emphasized log message
                ...
                for mod in diff.modified {
                    ...
                    for change in mod.changes {
                        if change.attributeName == "text" {
                            ...
                            print(
                                "      - \(change.attributeName): \(change.oldValue ?? "nil") -> \(change.newValue ?? "nil")",
                            )
                        }
                    }
                }
